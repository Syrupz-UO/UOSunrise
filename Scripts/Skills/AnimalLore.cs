...
namespace Server.SkillHandlers
{
	...
	public class AnimalLoreGump : Gump
	{
		...
		public AnimalLoreGump( BaseCreature c, int source ) : base( 25, 25 )
		{
			...
			AddHtml( 199, 68, 803, 21, @"<BODY><BASEFONT Color=White><BIG><CENTER>" + c.Name + " " + c.Title + "</CENTER></BIG></BASEFONT></BODY>", (bool)false, (bool)false);

			AddHtml( 105, 134, 144, 21, @"<BODY><BASEFONT Color=White><BIG>Attributes</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			if ( source == 0 && c.MinTameSkill > 0 )
			{
				AddHtml( 142, 415, 144, 21, @"<BODY><BASEFONT Color=White><BIG>Loyalty Rating</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
					string loyalty = "Wild";
				...
				AddHtml( 142, 473, 144, 21, @"<BODY><BASEFONT Color=White><BIG>Pack Instinct</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			AddHtml( 425, 136, 144, 21, @"<BODY><BASEFONT Color=White><BIG>Resistance</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			AddHtml( 426, 347, 144, 21, @"<BODY><BASEFONT Color=White><BIG>Damage</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			AddHtml( 750, 136, 144, 21, @"<BODY><BASEFONT Color=White><BIG>Combat Ratings</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			AddHtml( 751, 317, 144, 21, @"<BODY><BASEFONT Color=White><BIG>Lore & Knowledge</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			if ( source == 0 && c.MinTameSkill > 0 )
			{
				AddHtml( 751, 441, 144, 21, @"<BODY><BASEFONT Color=White><BIG>Preferred Foods</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
					string foodPref = "";
