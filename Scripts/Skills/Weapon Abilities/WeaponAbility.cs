	...
	public abstract class WeaponAbility
	{
		...
		public virtual double GetRequiredSkill( Mobile from )
		{
            ...
            if ( weapon != null && weapon.PrimaryAbility == this )
                ...
                return 80.0;
			else if (weapon != null && weapon.SecondaryAbility == Bladeweave) // WIZARD BLADEWEAVE FIX
                return 80.0;
            else if ( weapon != null && weapon.ThirdAbility == this ) // WIZARD
                return 90.0;
            else if ( weapon != null && weapon.FourthAbility == this ) // WIZARD
                return 100.0;
            else if ( weapon != null && weapon.FifthAbility == this ) // WIZARD
                return 110.0;
