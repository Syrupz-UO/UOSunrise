	...
	public class EpicCharacter : BasePerson
	{
		...
		{ 
			...
			if ( !from.Blessed )
			{
				...
				list.Add( new GiftGumpEntry( from, this ) );
			}
		}
		...
		{
			public GiftGumpEntry( Mobile from, Mobile giver ) : base( 6163, 3 )
			{
				m_Mobile = from;
				m_Giver = giver;
			}
			...
			public override void OnClick()
			{
				...
				if ( ((EpicCharacter)m_Giver).MyAlignment == "good" ){ if ( m_Mobile.Fame >= 4000 && m_Mobile.Karma >= 4000 ){ PassTest = true; } merit = "valor"; }
				else if ( ((EpicCharacter)m_Giver).MyAlignment == "evil" ){ if ( m_Mobile.Fame >= 4000 && m_Mobile.Karma <= -4000 ){ PassTest = true; } merit = "tenacity"; }
				else if ( ((EpicCharacter)m_Giver).MyAlignment == "neutral" ){ if ( m_Mobile.Fame >= 7000 ){ PassTest = true; } }

				if ( m_Mobile.TotalGold < 5000 )
				{
					m_Mobile.SendMessage( m_Giver.Name + " needs at least 5,000 gold to construct the item for you.");
				}
				else if ( !(HaveSpecialItemRequirement( m_Mobile )) )
				{
				...
				else if ( PassTest == true )
				{
					PlayerMobile mobile = (PlayerMobile) m_Mobile;
					{
						...
						{
							mobile.SendGump( new EpicBookGump( m_Mobile, m_Giver, 0 ) );
						}
					}
				}
				else
		...
		{
			public EpicBookGump( Mobile from, Mobile giver, int page ): base( 100, 100 )
			{
				m_Mobile = from;
				m_Giver = giver;
				...
				AddHtml( 162, 64, 200, 34, @"<BODY><BASEFONT Color=Black><BIG>     Tributary Gifts</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 444, 64, 180, 34, @"<BODY><BASEFONT Color=Black><BIG>     Tributary Gifts</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 126, 112, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem1, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 148, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem2, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 184, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem3, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 220, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem4, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 256, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem5, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 292, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem6, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 328, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem7, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 364, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem8, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 443, 112, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem9, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 148, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem10, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 184, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem11, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 220, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem12, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 256, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem13, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 292, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem14, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 328, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem15, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 364, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + Server.Items.ManualOfItems.GetRelicArtyForBook( showItem16, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			public override void OnResponse( NetState state, RelayInfo info )
			{
				...
				if ( tribute.MyAlignment == "good" && info.ButtonID > 0 && info.ButtonID < 262 && from.TotalGold >= 5000 && HaveSpecialItemRequirement( from ) )
				{
				...
				else if ( tribute.MyAlignment == "evil" && info.ButtonID > 0 && info.ButtonID < 262 && from.TotalGold >= 5000 && HaveSpecialItemRequirement( from ) )
				{
					if ( from.Fame >= 4000 && from.Karma <= -4000 )
					{
						from.Fame = from.Fame - 4000;
				...
				else if ( tribute.MyAlignment == "neutral" && info.ButtonID > 0 && info.ButtonID < 262 && from.TotalGold >= 5000 && HaveSpecialItemRequirement( from ) )
				{
					if ( from.Fame >= 7000 )
					{
