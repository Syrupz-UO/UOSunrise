	  ...
	  /* End Captcha Mod *///////////////////////////////////////////
		...
		*/
		...
		public override void OnSkillInvalidated( Skill skill )
		{
			...
			// WIZARD ADDED BELOW SO TAMERS ARE COOL //
			if ( skill.SkillName == SkillName.Herding )
				UpdateFollowers();

			// WIZARD ADDED BELOW SO NON-NECROS DO NOT GET TO KEEP WHITE SKIN //
		...
		{
			// FOR GM TESTING TO BE LIKE PLAYERS
		...
		public override void ComputeBaseLightLevels( out int global, out int personal )
		{
			...
			else if ( this.LightLevel < 13 && AosAttributes.GetValue( this, AosAttribute.NightSight ) > 0 ) // WIZARD ADDED FOR NIGHT SIGHT ITEMS TO BE LIKE POTIONS
				personal = 13;
		...
		public override int HitsMax
		{
			get
			{
				...
				return ( Server.Misc.DifficultyLevel.StatsPerAbility( strBase ) ) + strOffs; // CHANGED BY WIZARD
			}
		}
		...
		{
			get{ return ( Server.Misc.DifficultyLevel.StatsPerAbility( base.StamMax ) ) + AosAttributes.GetValue( this, AosAttribute.BonusStam ); } // WIZARD CHANGED
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public override int ManaMax
		{
			get{ return ( Server.Misc.DifficultyLevel.StatsPerAbility( base.ManaMax ) ) + AosAttributes.GetValue( this, AosAttribute.BonusMana ); } // WIZARD CHANGED
		}
		#endregion
		...
		public override bool Move( Direction d )
		{
			...
			if ( ns != null )
			{
				...
				else if ( HasGump( typeof( ResurrectNowGump ) ) ) { if ( Alive ) { CloseGump( typeof( ResurrectNowGump ) ); } }  // WIZARD ADDED FOR NEW DEATH GUMP
			}
		...
		public override bool AllowSkillUse( SkillName skill )
		{
            ...
            if (null != SafeResContext)          // <- Xanthos Safe Res change - added
                return (DesignContext.Check(this) && SafeResContext.AllowSkillUse(this, skill)); // <- Xanthos Safe Res change - added
            else                                   // <- Xanthos Safe Res change - added
                return DesignContext.Check(this);
		}
		...
		private bool CanInsure( Item item )
		{
			...
			// WIZARD NEEDS TO ALLOW RUNEBOOKS TO BE INSURED BECAUSE THEY ARE NOT BLESSED
		...
		protected override void OnLocationChange( Point3D oldLocation )
		{
			...
			if ( Server.Misc.DifficultyLevel.NoMountsInCertainRegions() && Region.Find( oldLocation, this.Map ) != Region.Find( this.Location, this.Map ) && Server.Mobiles.AnimalTrainer.IsNoMountRegion( Region.Find( this.Location, this.Map ) ) )
			{
				if ( this.Mounted )
				{
			...
			else if ( Server.Misc.DifficultyLevel.NoMountsInCertainRegions() && !Mounted && !(Server.Mobiles.AnimalTrainer.IsNoMountRegion( Region.Find( this.Location, this.Map ) ) ) && Alive )
			{
		...
		public override void Resurrect()
		{
			...
			{
				case 0: LoggingFunctions.LogGeneric( this, "has returned from the realm of the dead" );		break;
				case 1: LoggingFunctions.LogGeneric( this, "was brought back to the world of the living" );	break;
				case 2: LoggingFunctions.LogGeneric( this, "has been restored to life" );					break;
				case 3: LoggingFunctions.LogGeneric( this, "has been brought back from the grave" );		break;
				case 4: LoggingFunctions.LogGeneric( this, "has been resurrected to this world" );			break;
				case 5: LoggingFunctions.LogGeneric( this, "has returned to life after death" );			break;
				case 6: LoggingFunctions.LogGeneric( this, "was resurrected for another chance at life" );	break;
			}

			if ( this.QuestArrow != null ){ this.QuestArrow.Stop(); } // WIZARD - GET RID OF ARROW THAT POINTS GHOST TO RES SPOT

			if ( this.Alive && !wasAlive )
			{
					Item deathRobe = new DeathRobe();

                //Item deathRobe = new DeathRobe(); // <- Xanthos Safe Res change - commented 
                //if ( !EquipItem( deathRobe ) )    // <- Xanthos Safe Res change - commented 
                //deathRobe.Delete();                // <- Xanthos Safe Res change - commented
                Xanthos.SafeResurrection.SafeResContext.Add(this); // <- Xanthos Safe Res change - added
		...
		{
			if ( Server.Misc.SeeIfGemInBag.IHaveAGem( this ) == true ) // FOR THE GEM OF IMMORTALITY
			{
				return false;
			}
		...
		public static bool MovementThrottle_Callback( NetState ns )
		{
			...
			if ( pm != null )
			{
				if ( pm.FindItemOnLayer( Layer.Shoes ) != null )
				{
					...
					if ( shoes is BootsofHermes ){ return ( ts < FastwalkThreshold ); }
				}
			}
