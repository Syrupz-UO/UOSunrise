...
namespace Joeku.MOTD
{
	public class MOTD_Gump : Gump
	{
		...
		public MOTD_Gump( Mobile user, bool help, int index, int origin ) : base( 25, 25 )
		{
			...
			AddHtml( 177, 37, 230, 20, @"<BODY><BASEFONT Color=White><BIG>MESSAGE OF THE DAY</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			AddBody( user );
			AddItem(38, 269, 7775);
			AddHtml( 419, 531, 154, 20, @"<BODY><BASEFONT Color=White><BIG>SHOW AT LOGIN</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
