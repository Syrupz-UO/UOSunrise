...
//				list.Add( 1060660, "team\t{0}", m_Team );
		...
		public static void SpreadOut( Mobile m )
		{
			if ( m is BaseVendor )
			{
				...
				if ( m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.Felucca ){ m.Location = Worlds.GetRandomLocation( "the Land of Lodoria", "land" ); m.WhisperHue = 999; }
				else if ( m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.Trammel ){ m.Location = Worlds.GetRandomLocation( "the Land of Sosaria", "land" ); m.WhisperHue = 999; }
				else if ( m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.Malas ){ m.Location = Worlds.GetRandomLocation( "the Serpent Island", "land" ); m.WhisperHue = 999; }
				else if ( m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.Tokuno ){ m.Location = Worlds.GetRandomLocation( "the Isles of Dread", "land" ); m.WhisperHue = 999; }
				else if ( m.X >= 1125 && m.Y >= 298 && m.X <= 1131 && m.Y <= 305 && m.Map == Map.TerMur ){ m.Location = Worlds.GetRandomLocation( "the Savaged Empire", "land" ); m.WhisperHue = 999; }
				else if ( m.X >= 5116 && m.Y >= 4090 && m.X <= 5122 && m.Y <= 4096 && m.Map == Map.Trammel ){ m.Location = Worlds.GetRandomLocation( "the Land of Ambrosia", "land" ); m.WhisperHue = 999; }
				else if ( m.X >= 608 && m.Y >= 4090 && m.X <= 704 && m.Y <= 4096 && m.Map == Map.Trammel ){ m.Location = Worlds.GetRandomLocation( "the Island of Umber Veil", "land" ); m.WhisperHue = 999; }
			}
			else
			{
				...
				else if ( m.X >= 5116 && m.Y >= 4090 && m.X <= 5122 && m.Y <= 4096 && m.Map == Map.Trammel ){ m.Location = Worlds.GetRandomLocation( "the Land of Ambrosia", "sea" ); m.WhisperHue = 999; }
		...
		public static void SpreadItems( Item i )
		{
			if ( i is WaterChest )
			{
				...
				else if ( i.X >= 5116 && i.Y >= 4090 && i.X <= 5122 && i.Y <= 4096 && i.Map == Map.Trammel ){ i.Location = Worlds.GetRandomLocation( "the Land of Ambrosia", "land" ); }
			...
			else if ( i is LandChest )
			{
				...
				else if ( i.X >= 5116 && i.Y >= 4090 && i.X <= 5122 && i.Y <= 4096 && i.Map == Map.Trammel ){ i.Location = Worlds.GetRandomLocation( "the Land of Ambrosia", "sea" ); }
