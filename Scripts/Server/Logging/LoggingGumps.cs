...
namespace Server.Gumps
{
	public class LoggingGumpCrier : Gump
	{
        public LoggingGumpCrier( Mobile from, int page ) : base( 25, 25 )
        {
			...
			AddButton(100, 215, 4005, 4005, 2, GumpButtonType.Reply, 0);
			AddButton(100, 275, 4005, 4005, 3, GumpButtonType.Reply, 0);
			AddButton(100, 335, 4005, 4005, 4, GumpButtonType.Reply, 0);
			AddButton(100, 400, 4005, 4005, 5, GumpButtonType.Reply, 0);
			AddHtml( 177, 22, 518, 31, @"<BODY><BASEFONT Color=White><BIG>FROM THE NEWS OF THE TOWN CRIER</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			AddHtml( 145, 155, 222, 24, @"<BODY><BASEFONT Color=" + colorMenuA + "><BIG>Adventures in the Realm</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			AddHtml( 145, 215, 222, 24, @"<BODY><BASEFONT Color=" + colorMenuB + "><BIG>Exploration in the Realm</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			AddHtml( 145, 275, 222, 24, @"<BODY><BASEFONT Color=" + colorMenuC + "><BIG>Victories in Battle</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			AddHtml( 145, 335, 222, 24, @"<BODY><BASEFONT Color=" + colorMenuD + "><BIG>Recent Deaths</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			if ( page == 2 )
			{
				string sEvents = "Adventures In The Realm<br><br>" + LoggingFunctions.LogRead( "Logging Quests", from );
