...
namespace Server.Engines.Help
{
	...
	public class HelpGump : Gump
	{
		...
		public HelpGump( Mobile from, int page ) : base( 25, 25 )
		{
			...
			AddHtml( 181, 95, 618, 21, @"<BODY><BASEFONT Color=White><BIG>ULTIMA ADVENTURES - HELP OPTIONS</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			AddButton(100, 181, button_afk, button_afk, 2, GumpButtonType.Reply, 0);
				AddHtml( 141, 181, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>AFK</BIG></BASEFONT></BODY>", (bool)false, (bool)false);


			AddButton(100, 216, 4005, 4005, 3, GumpButtonType.Reply, 0);
				colorMenu = "#FCFF00"; if ( page == 3 ){ colorMenu = "#FFA200"; }
				AddHtml( 141, 216, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>Chat</BIG></BASEFONT></BODY>", (bool)false, (bool)false);


			AddButton(100, 251, 4005, 4005, 4, GumpButtonType.Reply, 0);
				colorMenu = "#FCFF00";
				if ( page == 4 )
				{
					colorMenu = "#FFA200";
				...
				AddHtml( 141, 251, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>Corpse Clear</BIG></BASEFONT></BODY>", (bool)false, (bool)false);


			AddButton(100, 286, 4005, 4005, 5, GumpButtonType.Reply, 0);
				colorMenu = "#FCFF00"; if ( page == 5 ){ colorMenu = "#FFA200"; }
				AddHtml( 141, 286, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>Corpse Search</BIG></BASEFONT></BODY>", (bool)false, (bool)false);


			AddButton(100, 321, 4005, 4005, 6, GumpButtonType.Reply, 0);
				colorMenu = "#FCFF00"; if ( page == 6 ){ colorMenu = "#FFA200"; }
				AddHtml( 141, 321, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>Emote</BIG></BASEFONT></BODY>", (bool)false, (bool)false);


			AddButton(100, 356, 4005, 4005, 7, GumpButtonType.Reply, 0);
				colorMenu = "#FCFF00";
				if ( page == 7 )
				{
					colorMenu = "#FFA200";
					...
					AddButton(310, 505, 4005, 4005, 76, GumpButtonType.Reply, 0);
					AddButton(350, 505, 4011, 4011, 95, GumpButtonType.Reply, 0);
					AddHtml( 390, 505, 300, 21, @"<BODY><BASEFONT Color=#FCFF00><BIG>Necromancer Spell Bar I</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
						AddButton(635, 505, 4005, 4005, 276, GumpButtonType.Reply, 0);
						AddHtml( 675, 505, 110, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Open Toolbar</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
						AddButton(865, 505, 4017, 4017, 376, GumpButtonType.Reply, 0);
						AddHtml( 905, 505, 110, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Close Toolbar</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					AddButton(310, 540, 4005, 4005, 77, GumpButtonType.Reply, 0);
					AddButton(350, 540, 4011, 4011, 95, GumpButtonType.Reply, 0);
					AddHtml( 390, 540, 300, 21, @"<BODY><BASEFONT Color=#FCFF00><BIG>Necromancer Spell Bar II</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
						AddButton(635, 540, 4005, 4005, 277, GumpButtonType.Reply, 0);
						AddHtml( 675, 540, 110, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Open Toolbar</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
						AddButton(865, 540, 4017, 4017, 377, GumpButtonType.Reply, 0);
						AddHtml( 905, 540, 110, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Close Toolbar</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					AddButton(310, 575, 4005, 4005, 78, GumpButtonType.Reply, 0);
					AddButton(350, 575, 4011, 4011, 95, GumpButtonType.Reply, 0);
					AddHtml( 390, 575, 300, 21, @"<BODY><BASEFONT Color=#FCFF00><BIG>Priest Prayers Bar I</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
						AddButton(635, 575, 4005, 4005, 278, GumpButtonType.Reply, 0);
						AddHtml( 675, 575, 110, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Open Toolbar</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
						AddButton(865, 575, 4017, 4017, 378, GumpButtonType.Reply, 0);
						AddHtml( 905, 575, 110, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Close Toolbar</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					AddButton(310, 610, 4005, 4005, 79, GumpButtonType.Reply, 0);
					AddButton(350, 610, 4011, 4011, 95, GumpButtonType.Reply, 0);
					AddHtml( 390, 610, 300, 21, @"<BODY><BASEFONT Color=#FCFF00><BIG>Priest Prayers Bar II</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
						AddButton(635, 610, 4005, 4005, 279, GumpButtonType.Reply, 0);
						AddHtml( 675, 610, 110, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Open Toolbar</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
						AddButton(865, 610, 4017, 4017, 379, GumpButtonType.Reply, 0);
						AddHtml( 905, 610, 110, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Close Toolbar</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				}
				AddHtml( 141, 356, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>Magic Toolbars</BIG></BASEFONT></BODY>", (bool)false, (bool)false);


			AddButton(100, 391, 4005, 4005, 8, GumpButtonType.Reply, 0);
				colorMenu = "#FCFF00"; if ( page == 8 ){ colorMenu = "#FFA200"; }
				AddHtml( 141, 391, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>Moongate Search</BIG></BASEFONT></BODY>", (bool)false, (bool)false);


			AddButton(100, 426, 4005, 4005, 9, GumpButtonType.Reply, 0);
				colorMenu = "#FCFF00"; if ( page == 9 ){ colorMenu = "#FFA200"; }
				AddHtml( 141, 426, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>MOTD</BIG></BASEFONT></BODY>", (bool)false, (bool)false);


			AddButton(100, 461, 4005, 4005, 10, GumpButtonType.Reply, 0);
				colorMenu = "#FCFF00";
				if ( page == 10 )
				{
					colorMenu = "#FFA200";
				...
				AddHtml( 141, 461, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>Quests</BIG></BASEFONT></BODY>", (bool)false, (bool)false);


			AddButton(100, 496, 4005, 4005, 11, GumpButtonType.Reply, 0);
				AddHtml( 141, 496, 150, 21, @"<BODY><BASEFONT Color=#FCFF00><BIG>Quick Bar</BIG></BASEFONT></BODY>", (bool)false, (bool)false);


			AddButton(100, 531, 4005, 4005, 12, GumpButtonType.Reply, 0);
				colorMenu = "#FCFF00";
				if ( page == 12 )
				{
					int setB = 3609;
					...
					AddButton(310, 155, setB, setB, 51, GumpButtonType.Reply, 0);
					AddButton(350, 155, 4011, 4011, 80, GumpButtonType.Reply, 0);
					AddHtml( 390, 155, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Ability Names</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.CharacterSheath == 1 ){ setB = 4018; } else { setB = 3609; }
					AddButton(310, 190, setB, setB, 52, GumpButtonType.Reply, 0);
					AddButton(350, 190, 4011, 4011, 81, GumpButtonType.Reply, 0);
					AddHtml( 390, 190, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Auto Sheath</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.CharMusical == "Forest" ){ setB = 4018; } else { setB = 3609; }
					AddButton(310, 225, setB, setB, 53, GumpButtonType.Reply, 0);
					AddButton(350, 225, 4011, 4011, 82, GumpButtonType.Reply, 0);
					AddHtml( 390, 225, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Music Tone</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					AddButton(310, 260, 4005, 4005, 65, GumpButtonType.Reply, 0);
					AddButton(350, 260, 4011, 4011, 83, GumpButtonType.Reply, 0);
					AddHtml( 390, 260, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Music Playlist</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( ((PlayerMobile)from).PublicMyRunUO == false ){ setB = 4018; } else { setB = 3609; }
					AddButton(310, 295, setB, setB, 54, GumpButtonType.Reply, 0);
					AddButton(350, 295, 4011, 4011, 84, GumpButtonType.Reply, 0);
					AddHtml( 390, 295, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Private</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					AddButton(310, 330, 4005, 4005, 55, GumpButtonType.Reply, 0);
					AddButton(350, 330, 4011, 4011, 85, GumpButtonType.Reply, 0);
					AddHtml( 390, 330, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Loot Options</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.ClassicPoisoning == 1 ){ setB = 4018; } else { setB = 3609; }
					AddButton(310, 365, setB, setB, 64, GumpButtonType.Reply, 0);
					AddButton(350, 365, 4011, 4011, 86, GumpButtonType.Reply, 0);
					AddHtml( 390, 365, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Classic Poisoning</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					AddButton(310, 400, 4005, 4005, 56, GumpButtonType.Reply, 0);
					AddButton(350, 400, 4011, 4011, 87, GumpButtonType.Reply, 0);
					AddHtml( 390, 400, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Skill Title</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					// ------------------------------------------------------------------------------------------------------------------------------

					AddButton(310, 435, 4005, 4005, 63, GumpButtonType.Reply, 0);
					AddButton(350, 435, 4011, 4011, 88, GumpButtonType.Reply, 0);
					AddHtml( 390, 435, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Reagent Bar - Alchemy</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					AddButton(310, 470, 4005, 4005, 60, GumpButtonType.Reply, 0);
					AddButton(350, 470, 4011, 4011, 89, GumpButtonType.Reply, 0);
					AddHtml( 390, 470, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Reagent Bar - Magery</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					AddButton(310, 505, 4005, 4005, 61, GumpButtonType.Reply, 0);
					AddButton(350, 505, 4011, 4011, 90, GumpButtonType.Reply, 0);
					AddHtml( 390, 505, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Reagent Bar - Necromancy</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					AddButton(310, 540, 4005, 4005, 62, GumpButtonType.Reply, 0);
					AddButton(350, 540, 4011, 4011, 91, GumpButtonType.Reply, 0);
					AddHtml( 390, 540, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Reagent Bar - Close All</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					// ------------------------------------------------------------------------------------------------------------------------------

					if ( DB.CharacterEvil == 0 && DB.CharacterOriental == 0 ){ setB = 4018; } else { setB = 3609; }
					AddButton(310, 575, setB, setB, 57, GumpButtonType.Reply, 0);
					AddButton(350, 575, 4011, 4011, 92, GumpButtonType.Reply, 0);
					AddHtml( 390, 575, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Play Style - Normal</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.CharacterEvil == 1 ){ setB = 4018; } else { setB = 3609; }
					AddButton(310, 610, setB, setB, 58, GumpButtonType.Reply, 0);
					AddButton(350, 610, 4011, 4011, 93, GumpButtonType.Reply, 0);
					AddHtml( 390, 610, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Play Style - Evil</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.CharacterOriental == 1 ){ setB = 4018; } else { setB = 3609; }
					AddButton(310, 645, setB, setB, 59, GumpButtonType.Reply, 0);
					AddButton(350, 645, 4011, 4011, 94, GumpButtonType.Reply, 0);
					AddHtml( 390, 645, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Play Style - Oriental</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					// ------------------------------------------------------------------------------------------------------------------------------

					AddButton(350, 680, 4011, 4011, 96, GumpButtonType.Reply, 0);
					AddHtml( 390, 680, 160, 20, @"<BODY><BASEFONT Color=#FFA200><BIG>Magery Spell Color</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.MagerySpellHue == 0x47E ){ setB = 4018; } else { setB = 3609; }
					AddButton(570, 680, setB, setB, 500, GumpButtonType.Reply, 0);
					AddHtml( 610, 680, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>White</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.MagerySpellHue == 0x94E ){ setB = 4018; } else { setB = 3609; }
					AddButton(700, 680, setB, setB, 501, GumpButtonType.Reply, 0);
					AddHtml( 740, 680, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>Black</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.MagerySpellHue == 0x48D ){ setB = 4018; } else { setB = 3609; }
					AddButton(830, 680, setB, setB, 502, GumpButtonType.Reply, 0);
					AddHtml( 870, 680, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>Blue</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.MagerySpellHue == 0x48E ){ setB = 4018; } else { setB = 3609; }
					AddButton(960, 680, setB, setB, 503, GumpButtonType.Reply, 0);
					AddHtml( 1000, 680, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>Red</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.MagerySpellHue == 0x48F ){ setB = 4018; } else { setB = 3609; }
					AddButton(570, 715, setB, setB, 504, GumpButtonType.Reply, 0);
					AddHtml( 610, 715, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>Green</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.MagerySpellHue == 0x490 ){ setB = 4018; } else { setB = 3609; }
					AddButton(700, 715, setB, setB, 505, GumpButtonType.Reply, 0);
					AddHtml( 740, 715, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>Purple</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.MagerySpellHue == 0x491 ){ setB = 4018; } else { setB = 3609; }
					AddButton(830, 715, setB, setB, 506, GumpButtonType.Reply, 0);
					AddHtml( 870, 715, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>Yellow</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			
					if ( DB.MagerySpellHue == 0 ){ setB = 4018; } else { setB = 3609; }
					AddButton(960, 715, setB, setB, 507, GumpButtonType.Reply, 0);
					AddHtml( 1000, 715, 64, 20, @"<BODY><BASEFONT Color=#FFA200><BIG>Default</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				}
				AddHtml( 141, 531, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>Settings</BIG></BASEFONT></BODY>", (bool)false, (bool)false);


			AddButton(100, 566, 4005, 4005, 13, GumpButtonType.Reply, 0);
				colorMenu = "#FCFF00"; if ( page == 13 ){ colorMenu = "#FFA200"; }
				AddHtml( 141, 566, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>Skills</BIG></BASEFONT></BODY>", (bool)false, (bool)false);


			AddButton(100, 601, 4005, 4005, 14, GumpButtonType.Reply, 0);
				colorMenu = "#FCFF00"; if ( page == 14 ){ colorMenu = "#FFA200"; }
				AddHtml( 141, 601, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>Statistics</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			{
				AddButton(100, 636, 4005, 4005, 15, GumpButtonType.Reply, 0);
				colorMenu = "#FCFF00"; if ( page == 15 ){ colorMenu = "#FFA200"; }
					AddHtml( 141, 636, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>Stuck in World</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			}

			AddButton(100, 671, 4005, 4005, 17, GumpButtonType.Reply, 0);
				AddHtml( 141, 671, 150, 21, @"<BODY><BASEFONT Color=#FCFF00><BIG>Wealth Bar</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

			AddButton(100, 706, 4005, 4005, 16, GumpButtonType.Reply, 0);
				colorMenu = "#FCFF00"; if ( page == 16 ){ colorMenu = "#FFA200"; }
				AddHtml( 141, 706, 150, 21, @"<BODY><BASEFONT Color=" + colorMenu + "><BIG>Weapon Abilities</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		}
		...
		public override void OnResponse( NetState state, RelayInfo info )
		{
			...
			if ( info.ButtonID >= 80 && info.ButtonID < 200 ) // SMALL INFO HELP WINDOWS
			{
			...
			else
			{
				switch ( info.ButtonID )
				{
					...
					case 15: // Stuck
					{
						...
						else if ( from.Region.CanUseStuckMenu( from ) && !CheckCombat( from ) && !from.Frozen && !from.Criminal && (Core.AOS || from.Kills < 5) )
						{
		...
		public static string MyQuests( Mobile from )
        {
			...
			if ( CharacterDatabase.GetKeys( from, "SkullGate" ) ){ sQuests = sQuests + "-Discovered the secret of Skull Gate.<br><br>"; }
			...
			if ( CharacterDatabase.GetDiscovered( from, "the Underworld" ) ){ sQuests = sQuests + "-Traveled to the Underworld.<br><br>"; }
		...
		public static string MyHelp()
        {
			string HelpText = "If you are looking for help exploring this world, you can learn about almost anything within the game world you travel. Some merchants sell scrolls or books that will explain how some skills can be performed, resources gathered, and even how elements of the world can be manipulated. A sage often sells many tomes of useful information on skills, weapon abilities, or various types of magics available. If you are totally new to this game, buy yourself a Guide to Adventure book from a sage if you lost the one you started with. This book explains how to navigate and play the game. You will also learn some things about how the world behaves such as merchant interactions, how to use items, and what to do when your character dies. Talk to the townsfolk to learn whatever you can. On this screen there are many options, information, and settings that can assist in your journey. Many of the options here have keyboard commands that are listed below. Make sure to check out the 'Info' section on your character's paperdoll as it has some vital information about your character.<br><br>"
				...
				+ "[spellhue ## - This command, following by a color reference hue number, will change all of your magery spell effects to that color.<br><br>"
    ...
    public class InfoHelpGump : Gump
    {
        ...
        public InfoHelpGump( int page, int origin ) : base( 25, 25 )
        {
			...
			else if ( page == 94 )
			{
				...
				info = "There is an oriental element to the game that most do not want to participate in. With classes such as Ninja and Samurai, some players may want to travel a world with this flavor added. This particular setting allows you to toggle between fantasy and oriental. When in the oriental mode, much of the treasure you will find will be of Chinese or Japanese historical origins. These types of items will most times be named to match the style. Items that once belonged to someone, will often have a name that fits in the oriental style. Some of the skill titles will change for you as well, but not all. Look over the book of skill titles (found within the game world) to see which titles will change based on this play style. Some of the relics and artwork you will find will also have this style, to perhaps decorate a home in this fashion. This option can be turned off and on at any time. You cannot have evil and oriental play modes on at the same time.";
			}
			else if ( page == 95 )
			{
				m_Origin = 7;
			...
			AddImage(154, 34, 162);
			AddImage(88, 132, 219);
			AddHtml( 185, 10, 403, 21, @"<BODY><BASEFONT Color=White><BIG>" + title + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
