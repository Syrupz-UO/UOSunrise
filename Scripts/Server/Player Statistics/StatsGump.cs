...
namespace Server.Gumps 
{
    public class StatsGump : Gump
    {
        ...
        public StatsGump ( Mobile from, int origin ) : base ( 25,25 )
        {
            ...
            int SDICap = 1000000;
				if ( SDICap > Server.Misc.DifficultyLevel.SpellDamageIncreaseVsMonsters() && Server.Misc.DifficultyLevel.SpellDamageIncreaseVsMonsters() > 0 ){ SDICap = Server.Misc.DifficultyLevel.SpellDamageIncreaseVsMonsters(); }
