...
namespace Server.Misc
{
    class RandomThings
    {
		public static int GetRandomColor( int color )
		{
			...
			if ( color == 0 ){ color = Utility.RandomMinMax( 0, 13 ); }
		...
		public static string MadeUpDungeon()
		{
			...
			switch( Utility.RandomMinMax( 0, 18 ) )
			{
				...
				case 10: sPlace = "Catacomb"; if ( Utility.RandomMinMax( 0, 1 ) == 1 ){ sPlace = "Catacombs"; } break;
		...
		public static string GetRandomWeapon()
		{
			...
			switch( Utility.RandomMinMax( 1, 50 ) )
			{
				...
				case 9: item = "bone harvester"; break;
				...
				case 43: item = "viking sword"; break;
		...
		public static string GetRandomArmorWeaponItem()
		{
			...
			switch( Utility.RandomMinMax( 0, 257 ) )
			{
				...
				case 113: item = "Bone Harvester"; break;
				...
				case 170: item = "Viking Sword"; break;
		...
		public static string GetRandomShipName( string captain )
		{
