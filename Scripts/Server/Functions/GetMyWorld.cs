...
namespace Server.Misc
{
    class Worlds
    {
		public static string GetMyWorld( Map map, Point3D location, int x, int y )
		{
			...
			// DUNGEON HOMES
			else if ( map == Map.Ilshenar && ( x > 1644 ) && ( y > 35 ) && ( x < 1818 ) && ( y < 163 ) ){ worldLocation = "the Land of Lodoria"; }
			else if ( map == Map.Ilshenar && ( x > 1864 ) && ( y > 32 ) && ( x < 2041 ) && ( y < 162 ) ){ worldLocation = "the Savaged Empire"; }
			else if ( map == Map.Ilshenar && ( x > 2098 ) && ( y > 27 ) && ( x < 2272 ) && ( y < 156 ) ){ worldLocation = "the Savaged Empire"; }
			else if ( map == Map.Ilshenar && ( x > 1647 ) && ( y > 184 ) && ( x < 1810 ) && ( y < 305 ) ){ worldLocation = "the Serpent Island"; }
			else if ( map == Map.Ilshenar && ( x > 1877 ) && ( y > 187 ) && ( x < 2033 ) && ( y < 302 ) ){ worldLocation = "the Island of Umber Veil"; }
			else if ( map == Map.Ilshenar && ( x > 2108 ) && ( y > 190 ) && ( x < 2269 ) && ( y < 305 ) ){ worldLocation = "the Serpent Island"; }
			else if ( map == Map.Ilshenar && ( x > 1656 ) && ( y > 335 ) && ( x < 1807 ) && ( y < 443 ) ){ worldLocation = "the Land of Sosaria"; }
			else if ( map == Map.Ilshenar && ( x > 1880 ) && ( y > 338 ) && ( x < 2031 ) && ( y < 445 ) ){ worldLocation = "the Land of Lodoria"; }
			else if ( map == Map.Ilshenar && ( x > 2111 ) && ( y > 335 ) && ( x < 2266 ) && ( y < 446 ) ){ worldLocation = "the Isles of Dread"; }
			else if ( map == Map.Ilshenar && ( x > 1657 ) && ( y > 496 ) && ( x < 1807 ) && ( y < 606 ) ){ worldLocation = "the Land of Sosaria"; }
			else if ( map == Map.Ilshenar && ( x > 1879 ) && ( y > 498 ) && ( x < 2031 ) && ( y < 605 ) ){ worldLocation = "the Savaged Empire"; }
			else if ( map == Map.Ilshenar && ( x > 2115 ) && ( y > 499 ) && ( x < 2263 ) && ( y < 605 ) ){ worldLocation = "the Land of Lodoria"; }
			else if ( map == Map.Ilshenar && ( x > 1657 ) && ( y > 641 ) && ( x < 1808 ) && ( y < 748 ) ){ worldLocation = "the Land of Lodoria"; }
			else if ( map == Map.Ilshenar && ( x > 1883 ) && ( y > 640 ) && ( x < 2033 ) && ( y < 745 ) ){ worldLocation = "the Savaged Empire"; }
			else if ( map == Map.Ilshenar && ( x > 2113 ) && ( y > 641 ) && ( x < 2266 ) && ( y < 747 ) ){ worldLocation = "the Isles of Dread"; }
			...
			else if ( map == Map.Ilshenar ){ worldLocation = "the Underworld"; }
		...
		public static void EnteredTheLand( Mobile from )
		{
			if ( from is PlayerMobile )
			{
				...
				if ( world == "the Land of Lodoria" ){ CharacterDatabase.SetDiscovered( from, world ); runLog = true; }
				else if ( world == "the Land of Sosaria" ){ CharacterDatabase.SetDiscovered( from, world ); runLog = true; }
				else if ( world == "the Island of Umber Veil" ){ CharacterDatabase.SetDiscovered( from, world ); runLog = true; }
				else if ( world == "the Land of Ambrosia" ){ CharacterDatabase.SetDiscovered( from, world ); runLog = true; }
				else if ( world == "the Serpent Island" ){ CharacterDatabase.SetDiscovered( from, world ); runLog = true; }
				else if ( world == "the Isles of Dread" ){ CharacterDatabase.SetDiscovered( from, world ); runLog = true; }
				else if ( world == "the Savaged Empire" ){ CharacterDatabase.SetDiscovered( from, world ); runLog = true; }
				else if ( world == "the Underworld" ){ CharacterDatabase.SetDiscovered( from, world ); runLog = true; }
		...
		public static string GetRegionName( Map map, Point3D location )
		{
			...
			if ( ( reg.IsDefault || reg.Name == null || reg.Name == "" ) )
			{
				...
				{
					if ( location.X >= 0 && location.Y >= 0 && location.X <= 1580 && location.Y <= 1598 ){ regionName = "the Underworld"; }
				}
		...
		public static void MoveToRandomDungeon( Mobile m )
		{
			...
			switch ( Utility.RandomMinMax( 0, 69 ) )
			{
				...
				case 16: loc = new Point3D(3943, 3370, 0); map = Map.Trammel; break; // the Catacomb
				...
				case 25: loc = new Point3D(5259, 262, 0); map = Map.Trammel; break; // Dungeon Doom
        ...
        public static string GetAreaEntrance( string zone, Map map )
        {
			...
			else if ( zone == "Dungeon Doom" && map == Map.Trammel ){ loc = new Point3D(1628, 2561, 0); }
        ...
        public static string GetDungeonListing()
        {
			...
			while ( i < 85 )
			{
				...
				else if ( i == 3 ){ dungeon = "Dungeon Doom"; location = GetAreaEntrance( dungeon, Map.Trammel ); listing = listing + "Sosaria<br>" + dungeon + "<br>" + location + "<br><br>"; }
		...
		public static Point3D GetRandomLocation( string world, string scape )
		{
            ...
            while ( tm < 1 )
            {
                ...
                {
					tl = Map.Trammel;
                    tx = Utility.RandomMinMax( 6127+swrapx, 7168-swrapx );
                    ty = Utility.RandomMinMax( 828+swrapy, 2742-swrapy );
                ...
                {
					tl = Map.Trammel;
                    tx = Utility.RandomMinMax( 5125+swrapx, 6123-swrapx );
                    ty = Utility.RandomMinMax( 3041+swrapy, 4092-swrapy );
                    tz = tl.GetAverageZ(tx, ty);
                ...
                {
					tl = Map.Trammel;
                    tx = Utility.RandomMinMax( 699+swrapx, 3129-swrapx );
                    ty = Utility.RandomMinMax( 2272+swrapy, 4095-swrapy );
                    tz = tl.GetAverageZ(tx, ty);
                ...
                {
					tl = Map.Trammel;
                    tx = Utility.RandomMinMax( 5821+swrapx, 6091-swrapx );
                    ty = Utility.RandomMinMax( 2741+swrapy, 3014-swrapy );
                    tz = tl.GetAverageZ(tx, ty);
                ...
                {
					tl = Map.Felucca;
                    tx = Utility.RandomMinMax( 6866+swrapx, 7042-swrapx );
                    ty = Utility.RandomMinMax( 136+swrapy, 306-swrapy );
                    tz = tl.GetAverageZ(tx, ty);
                ...
                {
					tl = Map.Felucca;
                    tx = Utility.RandomMinMax( 1+swrapx, 4080-swrapx );
                    ty = Utility.RandomMinMax( 1+swrapy, 5100-swrapy );
                    tz = tl.GetAverageZ(tx, ty);
                ...
                {
					tl = Map.Ilshenar;
                    tx = Utility.RandomMinMax( 10+swrapx, 1620-swrapx );
                    ty = Utility.RandomMinMax( 10+swrapy, 1599-swrapy );
                    tz = tl.GetAverageZ(tx, ty);
                ...
                {
					tl = Map.Malas;
                    tx = Utility.RandomMinMax( 1+swrapx, 1869-swrapx );
                    ty = Utility.RandomMinMax( 1+swrapy, 2046-swrapy );
                    tz = tl.GetAverageZ(tx, ty);
                ...
                {
					tl = Map.Tokuno;
                    tx = Utility.RandomMinMax( 1+swrapx, 1446-swrapx );
                    ty = Utility.RandomMinMax( 1+swrapy, 1446-swrapy );
                    tz = tl.GetAverageZ(tx, ty);
                ...
                {
					tl = Map.TerMur;
                    tx = Utility.RandomMinMax( 135+swrapx, 1160-swrapx );
                    ty = Utility.RandomMinMax( 8+swrapy, 1792-swrapy );
                    tz = tl.GetAverageZ(tx, ty);
                ...
                {
					tl = Map.Trammel;
                    tx = Utility.RandomMinMax( 1+swrapx, 5120-swrapx );
                    ty = Utility.RandomMinMax( 1+swrapy, 3126-swrapy );
                    tz = tl.GetAverageZ(tx, ty);
				...
				{
					if ( Server.Misc.Worlds.IsWaterTile( t.ID, 0 ) ) { LandOk = true; }
