...
namespace Server.Gumps
{
    public class NameAlterGump : Gump
    {
        public NameAlterGump(Mobile from) : base(25, 25)
        {
			...
			AddHtml( 175, 37, 349, 180, @"<BODY><BASEFONT Color=White><BIG>One of the main rules of this game is to have a unique fantasy name for your character. Don't name your character TacoChamp123 or Batman, for example. If you feel your name is appropriate, then retype your name here. Otherwise, enter a new name for yourself that is no longer than 16 characters.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
