				...
				if ( item != null )
				{
					if ( !item.Stackable || !cont.TryDropItem( from, item, false ) ) // WIZARD ADDED FOR SOME UN-ID STUFF
					{
						if ( DifficultyLevel.GetUnidentifiedChance() >= Utility.RandomMinMax( 1, 100 ) )
						{
							...
							else if ( item is BaseHat ){ itemID.SkillRequired = "ItemID"; itemID.VendorCanID = "Tailor"; cont.DropItem( itemID ); }
							else if ( item is BaseQuiver ){ itemID.SkillRequired = "ItemID"; itemID.VendorCanID = "Bowyer"; cont.DropItem( itemID ); }
							else if ( item is BaseInstrument ){ itemID.SkillRequired = "ItemID"; itemID.VendorCanID = "Bard"; cont.DropItem( itemID ); }
		...
		private static readonly LootPackItem[] ChippedGems = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( ChippedSkull ), 1 ),
		...
		private static readonly LootPackItem[] FlawedGems = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( FlawedSkull ), 1 ),
		...
		private static readonly LootPackItem[] PlainGems = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( PlainSkull ), 1 ),
		...
		private static readonly LootPackItem[] FlawlessGems = new LootPackItem[]
			{
				...
				new LootPackItem( typeof( FlawlessSkull ), 1 ),
...
// SOCKET ADDITION START
				new LootPackEntry( false, ChippedGems,	  10.0, 1 ),
				new LootPackEntry( false, FlawedGems,	  5.00, 1 ),
				new LootPackEntry( false, PlainGems,	  4.00, 1 ),
				new LootPackEntry( false, FlawlessGems,	  3.00, 1 ),				
// SOCKET ADDITION END
...
// SOCKET ADDITION START
				new LootPackEntry( false, ChippedGems,	  2.00, 1 ),
				new LootPackEntry( false, FlawedGems,	  1.00, 1 )
// SOCKET ADDITION END
			} );
...
// SOCKET ADDITION START
				new LootPackEntry( false, ChippedGems,	  4.0, 1 ),
				new LootPackEntry( false, FlawedGems,	  3.00, 1 ),
				new LootPackEntry( false, PlainGems,	  2.00, 1 ),
				new LootPackEntry( false, FlawlessGems,	  1.00, 1 )				
// SOCKET ADDITION END
			} );
		...
		public static readonly LootPack SeFilthyRich = new LootPack( new LootPackEntry[]
			{
				...
				// SOCKET ADDITION START
				new LootPackEntry( false, ChippedGems,	  5.00, 1 ),
				new LootPackEntry( false, FlawedGems,	  4.00, 1 ),
				new LootPackEntry( false, PlainGems,	  3.00, 1 ),
				new LootPackEntry( false, FlawlessGems,	  2.00, 1 ),	
				new LootPackEntry( false, PerfectGems,	  1.00, 1 )				
// SOCKET ADDITION END
			} );
		...
		public static readonly LootPack SeSuperBoss = new LootPack( new LootPackEntry[]
			{
				...
				// SOCKET ADDITION START
				new LootPackEntry( false, ChippedGems,	  10.00, 1 ),
				new LootPackEntry( false, FlawedGems,	  8.00, 1 ),
				new LootPackEntry( false, PlainGems,	  6.00, 1 ),
				new LootPackEntry( false, FlawlessGems,	  4.00, 1 ),	
				new LootPackEntry( false, PerfectGems,	  3.00, 1 )				
// SOCKET ADDITION END
			} );
		#endregion
		...
		public static readonly LootPack AosPoor = new LootPack( new LootPackEntry[]
			{
				...
				// SOCKET ADDITION START
				new LootPackEntry( false, ChippedGems,	  1.00, 1 )
// SOCKET ADDITION END
			} );
		...
		public static readonly LootPack AosAverage = new LootPack( new LootPackEntry[]
			{
				...
				// SOCKET ADDITION START
				new LootPackEntry( false, ChippedGems,	  3.00, 1 ),
				new LootPackEntry( false, FlawedGems,	  2.00, 1 ),
				new LootPackEntry( false, PlainGems,	  1.00, 1 )
// SOCKET ADDITION END
			} );
		...
		public static readonly LootPack AosFilthyRich = new LootPack( new LootPackEntry[]
			{
				...
				new LootPackEntry( false, PlainGems,	  6.00, 1 ),
				new LootPackEntry( false, FlawlessGems,	  4.00, 1 ),	
				new LootPackEntry( false, PerfectGems,	  2.00, 1 )				
// SOCKET ADDITION END
			} );
		...
		public static readonly LootPack AosSuperBoss = new LootPack( new LootPackEntry[]
			{
				...
				new LootPackEntry( false, ArtyItems,	 			  2.00, 1 ),
				// SOCKET ADDITION START
				new LootPackEntry( false, ChippedGems,	  15.00, 1 ),
				new LootPackEntry( false, FlawedGems,	  13.00, 1 ),
				new LootPackEntry( false, PlainGems,	  10.00, 1 ),
				new LootPackEntry( false, FlawlessGems,	  8.00, 1 ),	
				new LootPackEntry( false, PerfectGems,	  6.00, 1 )				
// SOCKET ADDITION END
			} );
		#endregion
	...
	public class LootPackEntry
	{
		...
		public static string MagicItemName( Item item, Mobile m, Region from )
		{
			...
			if ( from is DungeonRegion ){ RegionName = from.Name; }
...
/*
			...
			)
			{
				...
				int nEntry = 1;
				foreach (string wordz in names)
				{
					if ( nEntry == 2 && wordz != "" && wordz != null ){ name = wordz; }
					else if ( nEntry == 3 && wordz != "" && wordz != null ){ name = name + " " + wordz; }
					else if ( nEntry == 4 && wordz != "" && wordz != null ){ name = name + " " + wordz; }
					else if ( nEntry == 5 && wordz != "" && wordz != null ){ name = name + " " + wordz; }
					else if ( nEntry == 6 && wordz != "" && wordz != null ){ name = name + " " + wordz; }
					else if ( nEntry == 7 && wordz != "" && wordz != null ){ name = name + " " + wordz; }
					else if ( nEntry == 8 && wordz != "" && wordz != null ){ name = name + " " + wordz; }
					else if ( nEntry == 9 && wordz != "" && wordz != null ){ name = name + " " + wordz; }

					nEntry++;
				}
				if ( Server.Misc.MorphingTime.MakeSpecialMaterial( item, isEvil ) == true ){ name = item.Name; }
			}
*/
		...
		public static bool SkipMagicName( Item item )
		{
			...
			item is JesterHatofChuckles || item is ShaminoCrossbow || item is EarringsOfProtection || 
			...
			item is VelocityTargetx || item is MagiciansMempo || item is EvilMageGloves || 
	...
	public class LootPackItem
	{
		...
		public Item Construct( bool inTokuno )
		{
			try
			{
				...
				{
					if ( DifficultyLevel.GetUnidentifiedChance() >= Utility.RandomMinMax( 1, 100 ) ){ item = new UnknownLiquid(); }
					else{ item = Loot.RandomPotion(); }
				}
				else if ( m_Type == typeof( ClumsyMagicStaff ) ) // WIZARD WANDS
				{
					if ( DifficultyLevel.GetUnidentifiedChance() >= Utility.RandomMinMax( 1, 100 ) ){ item = new UnknownWand(); }
					else
					{
	...
	public class LootPackDice
	{
		...
		public int Roll()
		{
			...
			w = v * (DifficultyLevel.GetGoldCutRate() * .01);
