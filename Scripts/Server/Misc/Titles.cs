	...
	public class Titles
	{
		...
		public static string GetSkillTitle( Mobile mob ) {
			...
			if ( highest != null && highest.BaseFixedPoint >= 300 )
			{
				...
				if ( skillTitle.Contains("Shade") ){ skillTitle = skillTitle.Replace("Shade", "Skulker"); }
				if ( skillTitle.Contains("Rogue") ){ skillTitle = skillTitle.Replace("Rogue", "Sneak"); }
				if ( skillTitle.Contains("Infiltrator") ){ skillTitle = skillTitle.Replace("Infiltrator", "Lockpicker"); }
				if ( skillTitle.Contains("Mage") ){ skillTitle = skillTitle.Replace("Mage", "Wizard"); }
				if ( skillTitle.Contains("Paladin") ){ skillTitle = skillTitle.Replace("Paladin", "Knight"); }
				if ( skillTitle.Contains("Tamer") ){ skillTitle = skillTitle.Replace("Tamer", "Beastmaster"); }
				if ( skillTitle.Contains("Pickpocket") ){ skillTitle = skillTitle.Replace("Pickpocket", "Thief"); }
				if ( skillTitle.Contains("Fisherman") ){ skillTitle = skillTitle.Replace("Fisherman", "Sailor"); }
				if ( skillTitle.Contains("Stoic") ){ skillTitle = skillTitle.Replace("Stoic", "Meditator"); }
				if ( skillTitle.Contains("Armsman") ){ skillTitle = skillTitle.Replace("Armsman", "Mace Fighter"); }
				if ( skillTitle.Contains("Wrestler") ){ skillTitle = skillTitle.Replace("Wrestler", "Brawler"); }
				if ( skillTitle.Contains("Praegustator") ){ skillTitle = skillTitle.Replace("Praegustator", "Food Taster"); }
				if ( skillTitle.Contains("Warder") ){ skillTitle = skillTitle.Replace("Warder", "Spell Warder"); }

				if ( skillTitle.Contains("Wizard") && mob.Body == 0x191 ){ skillTitle = skillTitle.Replace("Wizard", "Sorceress"); }
				if ( skillTitle.Contains("Necromancer") && mob.Body == 0x191 ){ skillTitle = skillTitle.Replace("Necromancer", "Witch"); }

				if ( skillTitle.Contains("Knight") && mob.Karma < 0 ){ skillTitle = skillTitle.Replace("Knight", "Death Knight"); }
				if ( skillTitle.Contains("Sailor") && mob.Karma < 0 ){ skillTitle = skillTitle.Replace("Sailor", "Pirate"); }
