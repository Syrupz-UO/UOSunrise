...
namespace Server.Commands
{
	...
	{ 
		...
		{ 
			...
			AddHtml( 180, 36, 134, 18, @"<BODY><BASEFONT Color=White><BIG>EMOTES</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			AddItem(523, 50, 12753);
			AddHtml( 178, 67, 329, 67, @"<BODY><BASEFONT Color=White><BIG>Press any of the buttons below, and your character will perform the action.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
	...
	{ 
		...
		public EmoteMiniGump ( Mobile from, int page ) : base ( 25, 25 ) 
		{
			...
			AddImage(55, 302, 165);
			AddImage(55, 234, 165);
			AddHtml( 9, 10, 121, 21, @"<BODY><BASEFONT Color=White><BIG>EMOTE LIST</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			AddImage(144, 6, 131);
