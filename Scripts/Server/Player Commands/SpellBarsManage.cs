...
namespace Server.Gumps 
{
    public class SetupBarsMage1 : Gump
    {
		...
		public SetupBarsMage1 ( Mobile from, int origin ) : base ( 25,25 )
		{
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - MAGERY - I</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			if ( info.ButtonID < 1 && m_Origin > 0 ){ from.SendGump( new Server.Engines.Help.HelpGump( from, 7 ) ); from.PlaySound( 0x4A ); }
			else if ( info.ButtonID < 1 ){}
			else { from.SendGump( new SetupBarsMage1( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsMage2 : Gump
    {
 		...
 		public SetupBarsMage2 ( Mobile from, int origin ) : base ( 25,25 )
		{
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - MAGERY - II</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else { from.SendGump( new SetupBarsMage2( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsMage3 : Gump
    {
 		...
 		public SetupBarsMage3 ( Mobile from, int origin ) : base ( 25,25 )
		{
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - MAGERY - III</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else { from.SendGump( new SetupBarsMage3( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsMage4 : Gump
    {
		...
		public SetupBarsMage4 ( Mobile from, int origin ) : base ( 25,25 )
		{
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - MAGERY - IV</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else { from.SendGump( new SetupBarsMage4( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsNecro1 : Gump
    {
        ...
        public SetupBarsNecro1 ( Mobile from, int origin ) : base ( 25,25 )
        {
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - NECROMANCER - I</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else { from.SendGump( new SetupBarsNecro1( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsNecro2 : Gump
    {
        ...
        public SetupBarsNecro2 ( Mobile from, int origin ) : base ( 25,25 )
        {
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - NECROMANCER - II</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else { from.SendGump( new SetupBarsNecro2( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsChivalry1 : Gump
    {
        ...
        public SetupBarsChivalry1 ( Mobile from, int origin ) : base ( 25,25 )
        {
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - CHIVALRY - I</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else { from.SendGump( new SetupBarsChivalry1( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsChivalry2 : Gump
    {
        ...
        public SetupBarsChivalry2 ( Mobile from, int origin ) : base ( 25,25 )
        {
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - CHIVALRY - II</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else { from.SendGump( new SetupBarsChivalry2( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsBard1 : Gump
    {
        ...
        public SetupBarsBard1 ( Mobile from, int origin ) : base ( 25,25 )
        {
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - BARD - I</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else { from.SendGump( new SetupBarsBard1( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsBard2 : Gump
    {
        ...
        public SetupBarsBard2 ( Mobile from, int origin ) : base ( 25,25 )
        {
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - BARD - II</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else { from.SendGump( new SetupBarsBard2( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsDeath1 : Gump
    {
        ...
        public SetupBarsDeath1 ( Mobile from, int origin ) : base ( 25,25 )
        {
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - DEATH KNIGHT - I</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else { from.SendGump( new SetupBarsDeath1( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsDeath2 : Gump
    {
        ...
        public SetupBarsDeath2 ( Mobile from, int origin ) : base ( 25,25 )
        {
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - DEATH KNIGHT - II</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else { from.SendGump( new SetupBarsDeath2( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsPriest1 : Gump
    {
        ...
        public SetupBarsPriest1 ( Mobile from, int origin ) : base ( 25,25 )
        {
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - PRIEST - I</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else { from.SendGump( new SetupBarsPriest1( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}
...
namespace Server.Gumps 
{
    public class SetupBarsPriest2 : Gump
    {
        ...
        public SetupBarsPriest2 ( Mobile from, int origin ) : base ( 25,25 )
        {
			...
			AddHtml( 196, 79, 337, 21, @"<BODY><BASEFONT Color=White><BIG>SPELL BAR - PRIEST - II</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else { from.SendGump( new SetupBarsPriest2( from, m_Origin ) ); from.PlaySound( 0x4A ); }
		}
    }
}