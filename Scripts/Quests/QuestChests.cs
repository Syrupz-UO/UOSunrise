	...
	public class BardHarkynBox : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 2 ) )
			{
				...
				{
					CharacterDatabase.SetBardsTaleQuest( from, "BardsTaleSilverSquare" );
					CharacterDatabase.SetBardsTaleQuest( from, "BardsTaleCrystalSword" );
					from.SendSound( 0x3D );
	...
	public class BardMangarBox : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 2 ) )
			{
				...
				{
					CharacterDatabase.SetBardsTaleQuest( from, "BardsTaleSilverCircle" );
					from.SendSound( 0x3D );
	...
	public class CrystalStatueBoxKyl : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 2 ) )
			{
				...
				{
					CharacterDatabase.SetBardsTaleQuest( from, "BardsTaleBedroomKey" );
					from.SendSound( 0x3D );
	...
	public class DwarvenBox : Item
	{
		...
		public override void OnDoubleClick( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 2 ) )
			{
				...
				{
					CharacterDatabase.SetKeys( from, "UndermountainKey" );
					from.SendSound( 0x3D );
