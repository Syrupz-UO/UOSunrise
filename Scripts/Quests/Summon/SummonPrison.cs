...
namespace Server.Items
{
	public class SummonPrison : Item
	{
		...
		[Constructable]
		public SummonPrison() : base( 0xE2E )
		{
			Weight = 2.0;
			Name = "Magical Prison";
		...
		{
			int pick = Utility.RandomMinMax( 1, 24 );

			if ( pick == 1 ){		item.Prisoner = "Tiamat the Lord of Dragons";		item.PrisonerBase = "Dragon"; 			item.PrisonerBody = 105;	item.PrisonerHue = 0xA54; 
			...
			else if ( pick == 2 ){	item.Prisoner = "Bahamut the Platinum Dragon";		item.PrisonerBase = "Dragon"; 			item.PrisonerBody = 105; 	item.PrisonerHue = 0x430; 
				...
				item.PrisonerClothColorUsed = 0;			item.PrisonerFullNameUsed = 0; }
			else if ( pick == 5 ){	item.Prisoner = "Orcus the Daemon Prince";			item.PrisonerBase = "Daemon"; 			item.PrisonerBody = 0; 		item.PrisonerHue = 0xA93; 
				...
				item.PrisonerClothColorUsed = 0;			item.PrisonerFullNameUsed = 0; }
			else if ( pick == 8 ){	item.Prisoner = "Adimarchus the Demon Prince of Madness"; item.PrisonerBase = "Daemon";		item.PrisonerBody = 0; 		item.PrisonerHue = 0xA9E;
				item.RewardID = 0x2104;	item.RewardHue = 0xA9E;	item.RewardName = "Statue of " + item.Prisoner;
				item.PrisonerClothColorUsed = 0;			item.PrisonerFullNameUsed = 0; }
			else if ( pick == 9 ){	item.Prisoner = "Lord Verminaard";					item.PrisonerBase = "Berserker";		item.PrisonerBody = 0x190; 	item.PrisonerHue = Utility.RandomSkinHue();
			...
			else if ( pick == 11 ){	item.Prisoner = "Merlin the Wizard";				item.PrisonerBase = "EvilMage";			item.PrisonerBody = 0x190; 	item.PrisonerHue = Utility.RandomSkinHue();
				item.RewardID = 0x1718;	item.RewardHue = 0x674;	item.RewardName = "Hat of " + item.Prisoner;
				item.PrisonerClothColorUsed = 1;			item.PrisonerFullNameUsed = 0; }
			else if ( pick == 12 ){	item.Prisoner = "Saruman the White";				item.PrisonerBase = "EvilMage";			item.PrisonerBody = 0x190; 	item.PrisonerHue = Utility.RandomSkinHue();
				...
				item.PrisonerClothColorUsed = 0;			item.PrisonerFullNameUsed = 0; }
			else if ( pick == 17 ){	item.Prisoner = "Red Sonja";						item.PrisonerBase = "Berserker";		item.PrisonerBody = 0x191; 	item.PrisonerHue = Utility.RandomSkinHue();
				...
				item.PrisonerClothColorUsed = 1;			item.PrisonerFullNameUsed = 0; }
			else if ( pick == 20 ){	item.Prisoner = "Thor of Asgard";					item.PrisonerBase = "Berserker";		item.PrisonerBody = 0x190; 	item.PrisonerHue = Utility.RandomSkinHue();
				...
				item.PrisonerClothColorUsed = 0;			item.PrisonerFullNameUsed = 0; }
			else if ( pick == 24 ){	item.Prisoner = "Demogorgon";						item.PrisonerBase = "Balron";			item.PrisonerBody = 662; 	item.PrisonerHue = 0;
		...
		public static string GetItemNeeded( int item, int part )
		{
			...
			switch ( item )
			{
				...
				case 17: sWhere = "Vordo's Dungeon"; sWho = "a wild inferno"; sWhat = "cinders of life"; break;
