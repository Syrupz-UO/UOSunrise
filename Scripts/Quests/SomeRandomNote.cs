...
namespace Server.Items
{
	public class SomeRandomNote : Item
	{
		...
		[Constructable]
		public SomeRandomNote( ) : base( 0xE34 )
		{
			Weight = 1.0;
			Hue = 0xB98;
			...
			int amnt = Utility.RandomMinMax( 1, 45 );
			...
			if ( written == "lies" )
			{
				switch ( amnt )
				{
					...
					case 8:		ScrollMessage = "I found many tomes and scrolls that have led me to " + QuestCharacters.SomePlace( "random" ) + ". I will search there tomorrow, as " + QuestCharacters.QuestItems() + " will surely be in there."; break;
		...
		public class ClueGump : Gump
		{
			public ClueGump( Mobile from, Item parchment ): base( 100, 100 )
			{
				...
				AddPage(0);
				AddImage(37, 28, 1249);
				AddHtml( 86, 72, 303, 237, @"<BODY><BASEFONT Color=Black><BIG>" + sText + "</BIG></BASEFONT></BODY>", (bool)false, (bool)true);
			}
		}
