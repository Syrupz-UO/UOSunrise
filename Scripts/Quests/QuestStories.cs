...
namespace Server.Misc
{
    class QuestCharacters
    {
		...
		public static string EpicQuestStory( string QuestItem, string alignment )
		{
			...
			string sWord6 = "have it destroyed";
				...
				switch( nWord6 )
				{
					...
					case 3: sWord6 = "give it to the " + sWord5; 	break;
					case 4: sWord6 = "return it to " + sWord4; 		break;
					case 5: sWord6 = "return it to the " + sWord5;	break;
					...
					case 11: sWord6 = "keep it from the " + sWord5; break;
					case 12: sWord6 = "hide it from the " + sWord5; break;
			...
			string sWord11 = "so I may " + sWord6;
				...
				switch( nWord11 )
				{
					...
					case 16: sWord11 = "before the " + sWord5 + " " + sWord7 + " it";		break;
					case 17: sWord11 = "before " + sWord4 + " " + sWord7 + " it";			break;
					case 18: sWord11 = "before the " + sWord5 + " " + sWord7 + " it";		break;
					case 19: sWord11 = "before " + sWord4 + " " + sWord7 + " it";			break;
					case 20: sWord11 = "before the " + sWord5 + " " + sWord7 + " it";		break;
				}
		...
		public static string QuestItems()
		{
			...
			if ( FirstLast == 0 ) // FIRST COMES ADJECTIVE
			{
				...
				{
					case 0: name = "the '" + sAdjective + " " + name + " of " + ContainerFunctions.GetOwner( "property" ) + "'"; 	break;
					case 1: name = "the '" + name + " of " + ContainerFunctions.GetOwner( "property" ) + "'"; 						break;
					case 2: name = "the '" + sAdjective + " " + name + "'"; 														break;
					case 3: name = "the '" + sAdjective + " " + name + " of " + ContainerFunctions.GetOwner( "property" ) + "'"; 	break;
					case 4: name = "the '" + name + " of " + ContainerFunctions.GetOwner( "property" ) + "'"; 						break;
					case 5: name = "the '" + sAdjective + " " + name + "'"; 														break;
				}
			}
			else // FIRST COMES OWNER
			{
				...
				{
					case 0: name = "'" + OwnerName + " " + name + " of " + eAdjective + "'"; 										break;
					case 1: name = "the '" + name + " of " + eAdjective + "'"; 														break;
					case 2: name = "'" + OwnerName + " " + name + "'"; 																break;
					case 3: name = "'" + OwnerName + " " + sAdjective + " " + name + "'"; 											break;
				}
			}
