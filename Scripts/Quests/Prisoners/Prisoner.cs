		...
		private class PrisonerGump : Gump
		{
			...
			public override void OnResponse( NetState sender, RelayInfo info )
			{
				...
				if ( info.ButtonID == 1 )
				{
					...
					LoggingFunctions.LogGeneric( from, "has freed " + m_Jail.PrisonerName + " " + m_Jail.PrisonerTitle + "." );
