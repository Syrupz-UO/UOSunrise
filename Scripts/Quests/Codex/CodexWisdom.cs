...
namespace Server
{
    public class CodexGump : Gump
    {
        ...
        public CodexGump(CodexWisdom codex): base(25, 25)
        {
			...
			AddHtml( 175, 86, 900, 21, @"<BODY><BASEFONT Color=White><BIG>" + title + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
    ...
    public class LenseGump : Gump
    {
        ...
        public LenseGump(CodexWisdom codex, int status): base(25, 25)
        {
			...
			AddHtml( 77, 9, 509, 22, @"<BODY><BASEFONT Color=White><BIG>" + phrase + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
