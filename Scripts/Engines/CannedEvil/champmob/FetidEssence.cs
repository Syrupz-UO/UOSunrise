...
namespace Server.Mobiles
{
	...
	public class  AFetidEssence  : BaseCreature
	{
		[Constructable]
		public  AFetidEssence () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public  AFetidEssence ( Serial serial ) : base( serial )
		{
		}
