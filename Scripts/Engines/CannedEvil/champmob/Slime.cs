...
namespace Server.Mobiles
{
	...
	public class ASlime : BaseCreature
	{
		[Constructable]
		public ASlime() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Slime";
			Body = 51;
			BaseSoundID = 456;
		...
		public override void OnGaveMeleeAttack( Mobile m )
		{
			...
			if ( 1 == Utility.RandomMinMax( 1, 20 ) && this.Fame > 300 )
			{
				...
				if ( iWrapped != null )
				{
					...
					{
						m.LocalOverheadMessage(MessageType.Emote, 1150, true, "ASlime almost covered one of your protected items!");
					}
					else
					{
						m.LocalOverheadMessage(MessageType.Emote, 0x22, true, "One of your items is covered in ASlime!");
						m.PlaySound( 0x364 );
		...
		public ASlime( Serial serial ) : base( serial )
		{
		}
