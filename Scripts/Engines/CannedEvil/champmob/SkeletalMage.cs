...
namespace Server.Mobiles
{
	...
	public class ASkeletalMage : BaseCreature
	{
		[Constructable]
		public ASkeletalMage() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ASkeletalMage( Serial serial ) : base( serial )
		{
		}
