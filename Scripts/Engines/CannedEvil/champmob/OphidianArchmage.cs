...
namespace Server.Mobiles
{
	...
	public class AOphidianArchmage : BaseCreature
	{
		...
		[Constructable]
		public AOphidianArchmage() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public AOphidianArchmage( Serial serial ) : base( serial )
		{
		}
