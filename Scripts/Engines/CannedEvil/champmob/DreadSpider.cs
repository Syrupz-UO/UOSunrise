...
namespace Server.Mobiles
{
	...
	public class ADreadSpider : BaseCreature
	{
		...
		[Constructable]
		public ADreadSpider () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a dread spider";
			Body = 140;
			Hue = 0x4AA;
		...
		public ADreadSpider( Serial serial ) : base( serial )
		{
		}
