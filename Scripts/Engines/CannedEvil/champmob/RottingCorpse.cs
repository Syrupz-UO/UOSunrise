...
namespace Server.Mobiles
{
	...
	public class ARottingCorpse : BaseCreature
	{
		[Constructable]
		public ARottingCorpse() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ARottingCorpse( Serial serial ) : base( serial )
		{
		}
