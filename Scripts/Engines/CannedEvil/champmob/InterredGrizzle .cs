...
namespace Server.Mobiles
{
	...
	public class AInterredGrizzle  : BaseCreature
	{
		[Constructable]
		public  AInterredGrizzle () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		*/
		...
		public  AInterredGrizzle ( Serial serial ) : base( serial )
		{
		}
