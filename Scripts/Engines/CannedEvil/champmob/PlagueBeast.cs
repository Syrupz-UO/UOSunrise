...
namespace Server.Mobiles
{
	...
	public class APlagueBeast : BaseCreature, IDevourer
	{
		...
		[Constructable]
		public APlagueBeast() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a plague beast";
			Body = 775;
		...
		public APlagueBeast( Serial serial ) : base( serial )
		{
		}
