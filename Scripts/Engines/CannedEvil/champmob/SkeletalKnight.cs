...
namespace Server.Mobiles
{
	...
	public class ASkeletalKnight : BaseCreature
	{
		[Constructable]
		public ASkeletalKnight() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ASkeletalKnight( Serial serial ) : base( serial )
		{
		}
