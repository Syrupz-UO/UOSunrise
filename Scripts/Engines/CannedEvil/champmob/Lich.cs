...
{
	[CorpseName( "a ALiche's corpse" )]
	public class ALich : BaseCreature
	{
		[Constructable]
		public ALich() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = NameList.RandomName( "ancient ALich" );
			Title = "the ALich";
		...
		public ALich( Serial serial ) : base( serial )
		{
		}
