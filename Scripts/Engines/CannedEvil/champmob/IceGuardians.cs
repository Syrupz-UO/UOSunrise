...
namespace Server.Mobiles
{
	...
	public class AIceGuardians : BaseCreature
	{
		[Constructable]
		public AIceGuardians() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an ice guardian";
			Body = 311;
            Hue = 2066;
			BaseSoundID = 589;
		...
		public AIceGuardians( Serial serial ) : base( serial )
		{
		}
