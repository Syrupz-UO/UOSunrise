...
namespace Server.Mobiles
{
	...
	public class ARagingGrizzlyBear : BaseCreature
	{
		[Constructable]
		public ARagingGrizzlyBear() : base( AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
		...
		public ARagingGrizzlyBear( Serial serial ) : base( serial )
		{
		}
