...
namespace Server.Mobiles
{
	...
	public class APlagueSpawn : BaseCreature
	{
		...
		public APlagueSpawn( Mobile owner ) : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			m_Owner = owner;
		...
		public APlagueSpawn( Serial serial ) : base( serial )
		{
		}
