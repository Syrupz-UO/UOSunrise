...
namespace Server.Mobiles
{
	...
	public class AFireGargoyle : BaseCreature
	{
		...
		[Constructable]
		public AFireGargoyle() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public AFireGargoyle( Serial serial ) : base( serial )
		{
		}
