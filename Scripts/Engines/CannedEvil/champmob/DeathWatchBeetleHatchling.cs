...
namespace Server.Mobiles
{
	...
	public class ADeathwatchBeetleHatchling : BaseCreature
	{
		[Constructable]
		public ADeathwatchBeetleHatchling() : base( AIType.AI_Melee, Core.ML ? FightMode.Aggressor : FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ADeathwatchBeetleHatchling( Serial serial ) : base( serial )
		{
		}
