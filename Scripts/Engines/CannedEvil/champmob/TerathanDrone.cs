...
namespace Server.Mobiles
{
	...
	public class ATerathanDrone : BaseCreature
	{
		...
		[Constructable]
		public ATerathanDrone() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ATerathanDrone( Serial serial ) : base( serial )
		{
		}
