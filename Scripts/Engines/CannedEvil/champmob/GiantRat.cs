...
namespace Server.Mobiles
{
	...
	[TypeAlias( "Server.Mobiles.AGiantRat" )]
	public class AGiantRat : BaseCreature
	{
		[Constructable]
		public AGiantRat() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a giant rat";
			Body = 0xD7;
			BaseSoundID = 0x188;
		...
		public AGiantRat(Serial serial) : base(serial)
		{
		}
