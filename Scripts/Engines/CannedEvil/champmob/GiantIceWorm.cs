...
namespace Server.Mobiles
{
	...
	public class AGiantIceWorm : BaseCreature
	{
		public override bool SubdueBeforeTame { get { return true; } }

		[Constructable]
		public AGiantIceWorm() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Body = 21;
			Hue = 1152;
		...
		public AGiantIceWorm( Serial serial ) : base ( serial )
		{
		}
