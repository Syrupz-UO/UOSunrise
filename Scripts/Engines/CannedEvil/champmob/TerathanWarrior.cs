...
namespace Server.Mobiles
{
	...
	public class ATerathanWarrior : BaseCreature
	{
		...
		[Constructable]
		public ATerathanWarrior() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ATerathanWarrior( Serial serial ) : base( serial )
		{
		}
