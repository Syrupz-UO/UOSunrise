...
namespace Server.Mobiles
{
	...
	public class ASilverSerpent : BaseCreature
	{
		[Constructable]
		public ASilverSerpent() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Body = 21;
			Hue = 2403;
		...
		public ASilverSerpent(Serial serial) : base(serial)
		{
		}
