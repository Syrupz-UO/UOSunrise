...
namespace Server.Mobiles
{
	...
	public class APlagueBeastLord : BaseCreature, ICarvable, IScissorable
	{
		...
		[Constructable]
		public APlagueBeastLord() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public APlagueBeastLord( Serial serial ) : base( serial )
		{
		}
		...
		{
			private APlagueBeastLord m_Lord;
			private int m_Count;
