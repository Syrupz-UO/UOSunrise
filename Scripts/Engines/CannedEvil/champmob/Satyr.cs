...
namespace Server.Mobiles
{
	...
	public class ASatyr : BaseCreature
	{
		private DateTime m_NextPickup;

		[Constructable]
		public ASatyr() : base( AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			Name = "a Satyr";
			Body = 271;
			BaseSoundID = 0x586;
		...
		public void Undress( Mobile target )
		{
			...
			if ( target.Player && target.Female && !target.Hidden && CanBeHarmful( target ) )
			{
				...
				target.SendLocalizedMessage( 1072196 ); // The ASatyr's music makes your blood race. Your clothing is too confining.
			}
		...
		public ASatyr( Serial serial ) : base( serial )
		{
		}
