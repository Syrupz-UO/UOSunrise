...
namespace Server.Mobiles
{
	...
	public class ABoneKnight : BaseCreature
	{
		[Constructable]
		public ABoneKnight() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a bone knight";
		...
		public ABoneKnight( Serial serial ) : base( serial )
		{
		}
