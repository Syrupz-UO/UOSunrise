...
namespace Server.Mobiles
{
	...
	public class AStoneGargoyle : BaseCreature
	{
		[Constructable]
		public AStoneGargoyle() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public AStoneGargoyle( Serial serial ) : base( serial )
		{
		}
