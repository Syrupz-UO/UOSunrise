...
namespace Server.Mobiles
{
	...
	public class AIceStorm : BaseCreature
	{
		[Constructable]
		public AIceStorm () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an ice storm";
			Body = 0x23D;
			BaseSoundID = 40;
			...
			SetDamageType( ResistanceType.Cold, 85 );
		...
		public AIceStorm( Serial serial ) : base( serial )
		{
		}
