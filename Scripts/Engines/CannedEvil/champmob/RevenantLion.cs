...
namespace Server.Mobiles
{
	...
	public class ARevenantLion : BaseCreature
	{
		...
		[Constructable]
		public ARevenantLion() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an undead lion";
			Body = 251;
		...
		public ARevenantLion( Serial serial ) : base( serial )
		{
		}
