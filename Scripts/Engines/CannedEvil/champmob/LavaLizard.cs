...
namespace Server.Mobiles
{
	...
	public class ALavaLizard : BaseCreature
	{
		...
		[Constructable]
		public ALavaLizard() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a lava lizard";
			Body = 206;
		...
		public ALavaLizard(Serial serial) : base(serial)
		{
		}
