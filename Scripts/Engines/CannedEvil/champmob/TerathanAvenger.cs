...
namespace Server.Mobiles
{
	...
	public class ATerathanAvenger: BaseCreature
	{
		...
		[Constructable]
		public ATerathanAvenger() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ATerathanAvenger( Serial serial ) : base( serial )
		{
		}
