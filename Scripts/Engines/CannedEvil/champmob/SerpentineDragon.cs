...
namespace Server.Mobiles
{
	...
	public class ASerpentineDragon : BaseCreature
	{
		[Constructable]
		public ASerpentineDragon() : base( AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4 )
		{
		...
		public ASerpentineDragon( Serial serial ) : base( serial )
		{
		}
