...
namespace Server.Mobiles
{
	...
	public class ASnowDrake : BaseCreature
	{
		[Constructable]
		public ASnowDrake () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.15, 0.2 )
		{
            int i_Resource = 0;
			...
			if( Utility.RandomDouble() <= 0.01 ) PackItem( new ArmorBlessDeed() );
		}
		...
		public ASnowDrake( Serial serial ) : base( serial )
		{
		}
