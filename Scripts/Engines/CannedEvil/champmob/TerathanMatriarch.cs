...
namespace Server.Mobiles
{
	...
	public class ATerathanMatriarch : BaseCreature
	{
		...
		[Constructable]
		public ATerathanMatriarch() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ATerathanMatriarch( Serial serial ) : base( serial )
		{
		}
