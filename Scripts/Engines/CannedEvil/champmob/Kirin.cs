...
namespace Server.Mobiles
{
	...
	public class AKirin : BaseMount
	{
		...
		[Constructable]
		public AKirin() : this( "a Kirin" )
		{
		}

		[Constructable]
		public AKirin( string name ) : base( name, 132, 0x3EAD, AIType.AI_Mage, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			BaseSoundID = 0x3C5;
		...
		public AKirin( Serial serial ) : base( serial )
		{
		}
