			...
			res = new HarvestResource[]
				{
					...
					new HarvestResource( 114.0, 64.0, 143.0, "", typeof( NepturiteOre ),		typeof( NepturiteGranite ),		typeof( AnyElemental ) ),
					new HarvestResource( 119.0, 69.0, 148.0, "", typeof( ObsidianOre ),		typeof( ObsidianGranite ),		typeof( AnyElemental ) ),
					new HarvestResource( 123.0, 74.0, 153.0, "", typeof( MithrilOre ),		typeof( MithrilGranite ),		typeof( AnyElemental ) ),
					new HarvestResource( 128.0, 78.0, 158.0, "", typeof( XormiteOre ),		typeof( XormiteGranite ),		typeof( AnyElemental ) ),
					new HarvestResource( 133.0, 83.0, 161.0, "", typeof( DwarvenOre ),		typeof( DwarvenGranite ),		typeof( AnyElemental ) )
				};
			...
			veins = new HarvestVein[]
				{
					...
					new HarvestVein( 09.5, 0.5, res[1], res[0] ), // Dull Copper
					...
					new HarvestVein( 04.5, 0.5, res[9], res[0] ),  // Nepturite 
					new HarvestVein( 04.0, 0.5, res[10], res[0] ),  // Obsidian
					new HarvestVein( 04.0, 0.5, res[11], res[0] ),  // Mithril
					new HarvestVein( 03.5, 0.5, res[12], res[0] ),  // Xormite
					new HarvestVein( 05.5, 0.5, res[13], res[0] )  // Dwarven 
