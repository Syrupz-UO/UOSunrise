					...
					if ( from.Map == sos.TargetMap && from.InRange( sos.TargetLocation, 60 ) ) // WIZARD ADDED FOR MULTI-FACET SOS
					{
						...
						switch ( nWave )
						{
							...
							case 9:	// Container with Items
							{
								...
								{
									case 0: int goldBody = (int)(from.Skills[SkillName.Fishing].Value / 10) + 3; preLoot = new CorpseSailor(goldBody); break;
									case 1: int goldBag = (int)(from.Skills[SkillName.Fishing].Value / 10) + 3; preLoot = new SunkenBag(goldBag); break;
								}
								break;
							}
						}
						...
						int monster = Utility.RandomMinMax( 14, 15 );

						if ( sos.Level < 2 ){ monster = Utility.RandomMinMax( 1, 3 ); }
						else if ( sos.Level == 2 ){ monster = Utility.RandomMinMax( 4, 7 ); }
						else if ( sos.Level == 3 ){ monster = Utility.RandomMinMax( 8, 9 ); }
						else if ( sos.Level == 4 ){ monster = Utility.RandomMinMax( 10, 13 ); }
						...
						switch ( monster )
						{
							...
							case 4: creature = new SeaDrake(); 			Screature = "Shipwreck Drake";		break; // 2
							case 5: creature = new DeepSeaSerpent(); 	Screature = "Shipwreck Serpent";	break; // 2
							case 6: creature = new SeaHag(); 			Screature = "Shipwreck Hag";		break; // 2
							case 7: creature = new EyeOfTheDeep(); 		Screature = "Shipwreck Eye";		break; // 2
							case 8: creature = new SeaDragon(); 		Screature = "Shipwreck Dragon";		break; // 3
							case 9: creature = new DemonOfTheSea(); 	Screature = "Shipwreck Demon";		break; // 3
							case 10: creature = new SeaGiant(); 		Screature = "Shipwreck Giant";		break; // 4
							case 11: creature = new StormGiant(); 		Screature = "Shipwreck Giant";		break; // 4
							case 12: creature = new GiantSquid(); 		Screature = "Shipwreck Squid";		break; // 4
							case 13: creature = new SeaHagGreater(); 	Screature = "Shipwreck Hag";		break; // 4
							case 14: creature = new Kraken(); 			Screature = "Shipwreck Kraken";		break; // 5
							case 15: creature = new DeepSeaDragon(); 	Screature = "Shipwreck Wyrm";		break; // 5
						}
