...
namespace Server.Regions
{
	public class SafeRegion : BaseRegion
	{
		...
		public override void AlterLightLevel( Mobile m, ref int global, ref int personal )
		{
			...
			else if ( this.Name == "the Fort of Tenebrae" ){ global = LightCycle.DungeonLevel; }
		...
		public override bool OnBeginSpellCast( Mobile m, ISpell s )
		{
			...
			else if ( Worlds.IsAllowedSpell( m, s ) || this.Name == "the Forgotten Lighthouse" || this.Name == "the Fort of Tenebrae" )
			{
