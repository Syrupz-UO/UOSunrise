			...
			if ( from is PlayerMobile )
			{
				...
				else
				{
					...
					else if ( reg is PublicRegion )
					{
						...
						else if ( reg.IsPartOf( "the Black Magic Guild" ) ){ toPlay = MageList[Utility.Random(MageList.Length)]; }
						...
						else if ( reg.IsPartOf( "the Guardian's Chamber" ) ){ toPlay = MageList[Utility.Random(MageList.Length)]; }
