    ...
    public class AttributeHandler
    {
        ...
        public static void Initialize()
        {
            ...
            Definitions.Add(new AttributeHandler(EnhanceType.AosAttribute, "CastRecovery", "Faster Cast Recovery", 3, 1,
                !armor, !weapon, jewelry, spellbook, !shield, clothing));
            Definitions.Add(new AttributeHandler(EnhanceType.AosAttribute, "SpellDamage", "Luck", 12, 1,
                !armor, !weapon, jewelry, spellbook, !shield, clothing));
        }
        #endregion

        public AttributeHandler(EnhanceType type, string name, string description, int maxValue, int incrementValue, bool armor, bool weapon, bool jewelry, bool spellbook, bool shield, bool clothing)
        {
            Type = type;
            Name = name;
