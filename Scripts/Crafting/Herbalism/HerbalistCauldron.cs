	...
	public class HerbalistCauldron : Item
	{
		...
		public class DruidicGump : Gump
		{
			public DruidicGump( Mobile from, HerbalistCauldron bowl ): base( 25, 25 )
			{
				...
				AddHtml( 114, 89, 397, 24, @"<BODY><BASEFONT Color=White><BIG>DRUIDIC HERBALISM</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddItem(41, 499, 7719);
		...
		private class IngredientTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				else if ( m_Stage == 3 )
				{
					...
					else if ( obj is SilverSerpentVenom || obj is DragonBlood || obj is EnchantedSeaweed || obj is DragonTooth || obj is GoldenSerpentVenom || obj is LichDust || obj is DemonClaw || obj is UnicornHorn || obj is GhostlyDust || obj is DemigodBlood )
					{
						string AlchemyIngredient = "";
