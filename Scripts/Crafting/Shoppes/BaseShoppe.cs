...
namespace Server.Items
{
    ...
    public class ExplainShopped : Gump
    {
        ...
        public ExplainShopped( Mobile from, Mobile merchant ): base( 25, 25 )
        {
			...
			AddHtml( 143, 74, 347, 20, @"<BODY><BASEFONT Color=White><BIG><CENTER>SETTING UP SHOPPE</CENTER></BIG></BASEFONT></BODY>", (bool)false, (bool)false);
    ...
    public class ShoppeGump : Gump
    {
        ...
        public ShoppeGump( BaseShoppe shoppe, Mobile from ): base( 25, 25 )
        {
			...
			if ( shoppe.ShoppePage == 3 )
			{
				...
				AddHtml( 219, 70, 489, 20, @"<BODY><BASEFONT Color=White><BIG><CENTER>ABOUT SHOPPES</CENTER></BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else
			{
				...
				AddHtml( 219, 70, 489, 20, @"<BODY><BASEFONT Color=White><BIG><CENTER>" + shoppe.ShelfTitle + "</CENTER></BIG></BASEFONT></BODY>", (bool)false, (bool)false);
