...
namespace Server.Misc
{
    class Skulls
    {
		public static void MakeSkull( Mobile m, Container c, Mobile killer, string where )
		{
			...
			else if ( m is Balron ){ color = 0x430; bone = 2; }
			...
			else if ( m is ForestDemon ){ bone = 2; }
			else if ( m is RadiationDemon ){ bone = 2; }
			else if ( m is Daemon ){ color = 0x846; bone = 2; }
			else if ( m is IceFiend ){ color = 0x47F; bone = 2; }
