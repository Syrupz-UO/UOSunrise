				...
				else
				{
                    ...
                    if ( obj != null )
                    {
						...
						else
						{
							...
							{
								if (typeof( IceFiend ) == c.Owner.GetType() ){ trophyColor = 0x482; }
								else if (typeof( DeepSeaDevil ) == c.Owner.GetType() ){ trophyColor = 1365; }
								else if (typeof( Balron ) == c.Owner.GetType() && trophyColor == 0 ){ trophyColor = 0x430; }
								trophyID = 0x33A1;
							}
							...
							else if ( typeof( Exodus ) == c.Owner.GetType() ){ trophyID = 0x338D; }
							...
							else if ( typeof( Nightmare ) == c.Owner.GetType() || typeof( AncientNightmare ) == c.Owner.GetType() || typeof( Placeron ) == c.Owner.GetType() ){ trophyID = 0x33AD; }
