                    ...
                    if ( obj != null )
                    {
						...
						if ( m_Knife.HitPoints > 0 && !(c.VisitedByTaxidermist) && from.Skills[SkillName.Forensics].Value >= Utility.RandomMinMax( 30, 250 ) && giant.Slays(m) )
						{
							...
							if ( piece is FrankenBrain )
							{
								...
								brain.BrainLevel = ( DifficultyLevel.GetCreatureLevel( m ) + 5 ); // TITAN LICHES SEEM TO HAVE LEVEL 96 BRAINS
						...
						else if ( from.CheckSkill( SkillName.Forensics, -5, 100 ) )
						{
							...
							else if ( typeof( SailorWizard ) == c.Owner.GetType() ){ sName = "human blood"; }
							else if ( typeof( SailorArcher ) == c.Owner.GetType() ){ sName = "human blood"; }
							else if ( typeof( SailorMinstrel ) == c.Owner.GetType() ){ sName = "human blood"; }
							else if ( typeof( EvilSailorWizard ) == c.Owner.GetType() ){ sName = "human blood"; }
							else if ( typeof( EvilSailorArcher ) == c.Owner.GetType() ){ sName = "human blood"; }
							else if ( typeof( EvilSailorMinstrel ) == c.Owner.GetType() ){ sName = "human blood"; }
							...
							else if ( typeof( EvilWolf ) == c.Owner.GetType() ){ sName = "dog hairs"; }
							...
							else if ( typeof( ForestDemon ) == c.Owner.GetType() ){ sName = "enchanted sap"; }
							...
							else if ( typeof( RadiationDemon ) == c.Owner.GetType() ){ sName = "demonic hellfire"; }
							...
							else if ( typeof( ElfEvilSailorMinstrel ) == c.Owner.GetType() ){ sName = "elven blood"; }
							else if ( typeof( ElfEvilSailorArcher ) == c.Owner.GetType() ){ sName = "elven blood"; }
							else if ( typeof( ElfEvilSailorWizard ) == c.Owner.GetType() ){ sName = "elven blood"; }
							else if ( typeof( ElfSailorMinstrel ) == c.Owner.GetType() ){ sName = "elven blood"; }
							else if ( typeof( ElfSailorArcher ) == c.Owner.GetType() ){ sName = "elven blood"; }
							else if ( typeof( ElfSailorWizard ) == c.Owner.GetType() ){ sName = "elven blood"; }
							...
							else if ( typeof( Hobgoblin ) == c.Owner.GetType() ){ sName = "goblin brains"; }
							else if ( typeof( Goblin ) == c.Owner.GetType() ){ sName = "goblin brains"; }
							else if ( typeof( GoblinArcher ) == c.Owner.GetType() ){ sName = "goblin brains"; }
							...
							else if ( typeof( HellSteed ) == c.Owner.GetType() ){ sName = "liquid fire"; }
							else if ( typeof( HenchHorse ) == c.Owner.GetType() ){ sName = "animal tongues"; }
							else if ( typeof( Zebra ) == c.Owner.GetType() ){ sName = "animal tongues"; }
							else if ( typeof( EvilHorse ) == c.Owner.GetType() ){ sName = "animal tongues"; }
							...
							else if ( typeof( IceFiend ) == c.Owner.GetType() ){ sName = "enchanted frost"; }
							...
							else if ( typeof( Stegosaurus ) == c.Owner.GetType() ){ sName = "reptile scales"; }
							...
							else if ( typeof( EvilRidgeback ) == c.Owner.GetType() ){ sName = "reptile scales"; }
							...
							else if ( typeof( ScaledSwampDragon ) == c.Owner.GetType() ){ sName = "reptile scales"; }
							...
							else if ( typeof( EvilOstard ) == c.Owner.GetType() ){ sName = "ostard scales"; }
...
namespace Server.Items
{
	public class BottleOfParts : Item
	{
		...
		public static void FillJar( string guts, int value, Item jar )
		{
			...
			else if ( guts == "goblin brains" || value == 57 ){ jar.Hue = 0x2F6; jar.Name = "jar of goblin brains"; }
