		...
		public static void SetColorKeg( Item potion, Item keg )
		{
			...
			else
			{
				...
				switch ( p.Type )
				{
					...
					case PotionEffect.ElixirHealing : keg.Name = "keg of of the healer elixir"; break;
		...
		public static int GetPotionColor( Item potion )
		{
			...
			if ( potion is BasePotion )
			{
				...
				switch ( pot.PotionEffect )
				{
					...
					case PotionEffect.Conflagration : color = 0x489; break;
					case PotionEffect.ConflagrationGreater : color = 0x489; break;
