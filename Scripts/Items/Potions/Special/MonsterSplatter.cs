		...
		public override bool OnMoveOver( Mobile m )
		{
			...
			if ( hurts )
			{
				...
				else if ( this.Name == "lesser poison potion" || this.Name == "poison potion" || this.Name == "greater poison potion" | this.Name == "deadly poison potion" || this.Name == "lethal poison potion" )
				{
					...
					if ( this.Name == "poison potion" ){ 				pMin = pMin+2; 	pMax = pMax+2;	pLevel = 4;	pois = Poison.Regular; }
					else if ( this.Name == "greater poison potion" ){ 	pMin = pMin+3; 	pMax = pMax+3;	pLevel = 3;	pois = Poison.Greater; }
					else if ( this.Name == "deadly poison potion" ){ 	pMin = pMin+4; 	pMax = pMax+4;	pLevel = 2;	pois = Poison.Deadly; }
					else if ( this.Name == "lethal poison potion" ){ 	pMin = pMin+5; 	pMax = pMax+5;	pLevel = 1;	pois = Poison.Lethal; }
