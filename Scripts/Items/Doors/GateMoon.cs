...
namespace Server.Items
{
	public class GateMoon : Item
	{
		...
		public class MoonGateGump : Gump
		{
			public MoonGateGump( Mobile from, bool IsBlackrock ): base( 25, 25 )
			{
				...
				string mainTitle = "MOONGATE DESTINATIONS";
					if ( IsBlackrock ){ mainTitle = "BLACKROCK GATE DESTINATIONS"; AddItem(697, 362, 6248); } else { AddItem(765, 397, 3948); } 

				AddHtml( 140, 72, 600, 21, @"<BODY><BASEFONT Color=White><BIG><CENTER>" + mainTitle + "</CENTER></BIG></BASEFONT></BODY>", (bool)false, (bool)false);
		...
		public static string GetGateName( int gate, Mobile m )
		{
			...
			else if ( gate == 1 ){ sGate = "Sosaria - Central"; }
			else if ( gate == 2 ){ sGate = "Sosaria - Clues"; }
			else if ( gate == 3 ){ sGate = "Sosaria - Devil Guard"; }
			else if ( gate == 4 ){ sGate = "Sosaria - East"; }
			else if ( gate == 5 ){ sGate = "Sosaria - Frozen Isles"; }
			else if ( gate == 6 ){ sGate = "Sosaria - Lost Glade"; }
			else if ( gate == 7 ){ sGate = "Sosaria - Montor"; }
			else if ( gate == 8 ){ sGate = "Sosaria - Moon"; }
			else if ( gate == 9 ){ sGate = "Sosaria - West"; }
			else if ( gate == 10 ){ sGate = "Sosaria - Yew"; }
