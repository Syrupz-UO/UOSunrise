	...
	public class SlayerGroup
	{
		...
		static SlayerGroup()
		{
			...
			humanoid.Super = new SlayerEntry( SlayerName.Repond, 
				...
				typeof( SailorWizard ), 
				typeof( SailorArcher ), 
				typeof( SailorMinstrel ), 
				typeof( EvilSailorWizard ), 
				typeof( EvilSailorArcher ), 
				typeof( EvilSailorMinstrel ), 
				typeof( Minstrel ), 
			...
			fey.Super = new SlayerEntry( SlayerName.Fey, 
				...
				typeof( Pixie ), 
				typeof( Fairy ), 
				typeof( ElfSailorArcher ), 
				typeof( ElfSailorWizard ), 
				typeof( ElfSailorMinstrel ), 
				typeof( ElfEvilSailorArcher ), 
				typeof( ElfEvilSailorWizard ), 
				typeof( ElfEvilSailorMinstrel ), 
				typeof( ElfRogue ), 
				typeof( ElfMinstrel ), 
