...
namespace Server.Items
{
	...
	public abstract class BaseWeapon : Item, IWeapon, IFactionItem, ICraftable, ISlayer, IDurability
	{
		...
		public virtual WeaponAbility ThirdAbility{ get{ return null; } } // WIZARD
		public virtual WeaponAbility FourthAbility{ get{ return null; } } // WIZARD
		public virtual WeaponAbility FifthAbility{ get{ return null; } } // WIZARD
...
// XmlAttachment check for OnEquip
	    Server.Engines.XmlSpawner2.XmlAttach.CheckOnEquip(this, from);
			CustomWeaponAbilities.Check(this,from); // WIZARD ADDED FOR NEW WEAPON SPECIALS
		...
		public override void OnRemoved( object parent )
		{
			if ( parent is Mobile )
			{
				...
				CustomWeaponAbilities.Check(m); // WIZARD ADDED FOR NEW WEAPON SPECIALS
			}
	...
	int virtualArmor = defender.VirtualArmor + defender.VirtualArmorMod;
		...
		public virtual void OnHit( Mobile attacker, Mobile defender, double damageBonus )
		{
			...
			// New stuff for BladeWeaing performing Armor Ignore attack // WIZARD
		...
		public virtual void DoDispel( Mobile attacker, Mobile defender )
		{
			if ( defender is BaseCreature )
			{
				...
				if ( bc.ControlSlots == 666 ) // FOR SPECIAL SUMMONED WIZARD CREATURES
				{
		...
		{
			//if ( damage > 0 ) // WIZARD DID THIS SO BLEEDIMMUNE DOES NOT BLEED
		...
		public virtual double ScaleDamageAOS( Mobile attacker, double damage, bool checkSkills )
		{
			...
			double totalBonus = strengthBonus + anatomyBonus + tacticsBonus + armsLoreBonus + lumberBonus + ((double)(GetDamageBonus() + damageBonus) / 100.0);
...
// Xml Spawner XmlSockets - EOF
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			if ( (prop = m_AosAttributes.NightSight) != 0 && !(this is LightSword) && !(this is DoubleLaserSword) )
			...
			if ( Core.SE || m_AosWeaponAttributes.UseBestSkill == 0 )
			{
				switch ( Skill )
				{
					...
					case SkillName.Wrestling: list.Add( "skill required: wrestling" ); break; // skill required: wrestling // WIZARD ADDED
				}
			}
