...
namespace Server.Items
{
	public class DataPad : Item
	{
		...
		public DataPad( ) : base( 0x27FB )
		{
			...
			if ( DataID < 1 ){ DataID = Utility.RandomMinMax( 0, 55 ); }
