...
namespace Server.Misc
{
	class ArtifactBuilder
	{
		public static Item CreateArtifact( string arty )
		{
			...
			if ( artifact == null ){ artifact = Loot.RandomArty(); }
		...
		public static Item CreateMetalWeapon()
		{
			...
			switch ( nType )
			{
				...
				case 7:		item = new VikingSword();		item.Name = "greatsword";		break;
				case 8:		item = new Scimitar();			item.Name = "scimitar";			break;
				case 9:		item = new BoneHarvester();		item.Name = "bone harvester";	break;
