	...
	public class LegendsBook : Item
	{
		...
		public class LegendsBookGump : Gump
		{
			...
			public LegendsBookGump( Mobile from, LegendsBook wikipedia, int page ): base( 100, 100 )
			{
				...
				int NumberOfArtifacts = 269;	// SEE LISTING BELOW AND MAKE SURE IT MATCHES THE AMOUNT
				...
				AddHtml( 162, 64, 200, 34, @"<BODY><BASEFONT Color=Black><BIG>    Legendary Artifacts</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 444, 64, 180, 34, @"<BODY><BASEFONT Color=Black><BIG>    Legendary Artifacts</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 126, 112, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem1, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 148, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem2, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 184, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem3, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 220, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem4, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 256, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem5, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 292, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem6, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 328, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem7, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 364, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem8, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 443, 112, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem9, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 148, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem10, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 184, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem11, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 220, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem12, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 256, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem13, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 292, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem14, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 328, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem15, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 364, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetLegendArtyForBook( showItem16, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			public override void OnResponse( NetState state, RelayInfo info )
			{
				...
				else if ( canChoose == true && info.ButtonID > 0 && info.ButtonID < 270 && pack.ConsumeTotal(typeof(Gold), 10000))
				{
		...
		public static string GetLegendArtyForBook( int artifact, int part )
		{
			...
			if ( artifact == arty) { name="LevelOrcHelm"; item="Orc Helm"; } arty++;
			...
			if ( artifact == arty) { name="LevelBoneHarvester"; item="Bone Harvester"; } arty++;
			...
			if ( artifact == arty) { name="LevelVikingSword"; item="Viking Sword"; } arty++;
