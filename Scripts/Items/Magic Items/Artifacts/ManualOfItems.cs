	...
	public class ManualOfItems : Item
	{
		...
		public class ManualOfItemsGump : Gump
		{
			public ManualOfItemsGump( Mobile from, ManualOfItems wikipedia, int page ): base( 100, 100 )
			{
				...
				AddHtml( 162, 64, 200, 34, @"<BODY><BASEFONT Color=Black><BIG>      Tome of Relics  </BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 444, 64, 180, 34, @"<BODY><BASEFONT Color=Black><BIG>      Tome of Relics  </BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 126, 112, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem1, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 148, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem2, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 184, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem3, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 220, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem4, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 256, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem5, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 292, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem6, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 328, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem7, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 364, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem8, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 443, 112, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem9, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 148, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem10, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 184, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem11, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 220, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem12, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 256, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem13, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 292, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem14, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 328, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem15, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 364, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetRelicArtyForBook( showItem16, 1 ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			public override void OnResponse( NetState state, RelayInfo info )
			{
				...
				else if ( info.ButtonID > 0 && info.ButtonID < 270 )
				{
		...
		public static string GetRelicArtyForBook( int artifact, int part )
		{
			...
			if ( artifact == arty) { name="GiftOrcHelm"; item="Orc Helm"; } arty++;
			...
			if ( artifact == arty) { name="GiftBoneHarvester"; item="Bone Harvester"; } arty++;
			...
			if ( artifact == arty) { name="GiftVikingSword"; item="Viking Sword"; } arty++;
