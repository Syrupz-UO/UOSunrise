...
namespace Server.Items
{
	public class MagicHammer : Item
	{
        ...
        public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			list.Add( 1070722, "Changes the Name and Appearance of Metal Armor");
            list.Add( 1049644, "Helms, Shields, and Armor");
        } 
		...
		private class WearTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				else if ( iWear is BaseArmor && Server.Misc.MaterialInfo.IsAnyKindOfMetalItem( iWear ) )
				{
					...
					else if ( iWear.ItemID == 0x1412 || iWear.ItemID == 0x1419 ){ DoEffects = true; iWear.ItemID = 0x1F0B; NewName = "orc helm"; }
					...
					if ( DoEffects )
					{
						iWear.Name = NewName;
						from.PlaySound( 0x2A );
						from.SendMessage( "The hammer magical transform the armor." );
					}
					else
					{
