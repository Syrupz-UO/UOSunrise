...
namespace Server.Items
{
	public class NewFish : Item, ICarvable
	{
		...
		{
			ItemID = Utility.RandomList( 0x22AF, 0x22AE, 0x22AD, 0x22AC, 0x22AB, 0x22AA, 0x22A7, 0x22A8, 0x22B2, 0x22B1, 0x22B0, 0x44C3, 0x44C4, 0x44C5, 0x44C6, 0x4302, 0x4303, 0x4304, 0x4305, 0x4306, 0x4307, 0x9CC, 0x9CD, 0x9CE, 0x9CF );
			Hue = GetHue( 0 );
			Weight = 1.0;
