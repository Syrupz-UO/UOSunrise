...
namespace Server.Items
{
	public class SOS : Item
	{
		...
		[Constructable]
		public SOS( string world, int level ) : base( 0x12AD )
		{
			...
			ShipName = RandomThings.GetRandomShipName( "" );
		...
		private class MessageGump : Gump
		{
			public MessageGump( Map map, Point3D loc, string world, string story ) : base( 150, 50 )
			{
				...
				AddPage(0);
				AddImage(46, 26, 1247);
				AddHtml( 102, 58, 284, 202, @"<BODY><BASEFONT Color=Black><BIG>" + story + "</BIG></BASEFONT></BODY>", (bool)false, (bool)true);
				AddHtml( 102, 264, 280, 22, @"<BODY><BASEFONT Color=Black><BIG>" + fmt + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			}
		}
	}
}