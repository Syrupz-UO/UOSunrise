    ...
    public class MonsterManual : Item
	{
		...
		private class BookTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				else if (	targeted is BaseVendor || targeted is BasePerson || targeted is Citizen || targeted is PackBeast || 
							targeted is FrankenPorter || targeted is FrankenFighter || targeted is HenchmanFamiliar || 
