		...
		public override void OnTrigger( Mobile from )
		{
			...
			switch( ShroomType )
			{
				case 1:
						...
						from.LocalOverheadMessage(MessageType.Emote, 0x22, true, "A mushroom exploded near you!");
				...
				case 2:
						...
						from.LocalOverheadMessage(MessageType.Emote, 0x22, true, "A mushroom released odd spores!");
				...
				case 3:
						...
						from.LocalOverheadMessage(MessageType.Emote, 0x22, true, "A mushroom released strange energy!");
