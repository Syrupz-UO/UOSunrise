	...
	public class HiddenTrap : Item
	{
		...
		public override bool OnMoveOver( Mobile m )
		{
			...
			if ( m is PlayerMobile )
			{
				...
				if ( nSprung == 1 )
				{
					int nTrapType = Utility.RandomMinMax( 1, 23 );
					...
					if ( nTrapType == 1 && SavingThrow( m, "Magic" ) == false ) // REVEALING TRAP
					{
						...
						if ( m.Hidden != false ){ m.LocalOverheadMessage(MessageType.Emote, 0x22, true, textSay); sTrapType = textLog; }
					}
					else if ( nTrapType == 2 && SavingThrow( m, "Agility" ) == false ) // TRIP WIRE
					{
						...
						if ( HowBad == 1 )
						{
							...
							if ( nDrop > 0 )
							{
								...
								m.LocalOverheadMessage(MessageType.Emote, 0x22, true, textSay);
					...
					else if ( nTrapType == 3 && SavingThrow( m, "Magic" ) == false ) // COINS TO LEAD TRAP
					{
					...
					else if ( nTrapType == 4 && SavingThrow( m, "Magic" ) == false ) // LOSE ITEM TRAP
					{
					...
					else if ( nTrapType == 5 && SavingThrow( m, "Magic" ) == false ) // LOSE A STAT TRAP
					{
					...
					else if ( nTrapType == 6 && SavingThrow( m, "Poison" ) == false ) // POISON TRAP
					{
					...
					else if ( nTrapType == 7 && SavingThrow( m, "Magic" ) == false ) // DRAIN TRAP
					{
						int nStat = Utility.RandomMinMax( 1, 3 );
					...
					else if ( nTrapType == 8 && SavingThrow( m, "Magic" ) == false ) // GEM STONE TRAP
					{
					...
					else if ( nTrapType == 9 && SavingThrow( m, "Magic" ) == false ) // REAGENT TRAP
					{
						int nAmount = 0;
					...
					else if ( nTrapType == 10 && SavingThrow( m, "Magic" ) == false ) // BOOK BOUND TRAP
					{
						Container cont = m.Backpack;
						int nDull = 0;
						...
						if ( nDull > 0 )
						{
							...
							m.LocalOverheadMessage(MessageType.Emote, 0x22, true, "A trap triggered, locking your books in a magic box!");
							m.FixedParticles( 0x374A, 10, 15, 5028, EffectLayer.Waist );
							m.PlaySound( 0x1E1 );
							sTrapType = "a book bound trap";
						}
					}
					else if ( nTrapType == 11 && SavingThrow( m, "Magic" ) == false ) // TELEPORT TRAP
					{
					...
					else if ( nTrapType == 12  && SavingThrow( m, "Magic" ) == false && m.Fame > 0 ) // FAME TRAP
					{
						...
						{
							m.Fame = FameLoss;
							m.LocalOverheadMessage(MessageType.Emote, 0x22, true, "A trap triggered, causing some of your deeds to be forgotten!");
							m.FixedParticles( 0x374A, 10, 15, 5032, EffectLayer.Head );
							m.PlaySound( 0x1F8 );
							sTrapType = "a forgotten fame trap";
						}
					}
					else if ( nTrapType == 13 && SavingThrow( m, "Magic" ) == false ) // CURSE ITEM TRAP
					{
						Container cont = m.Backpack;
						...
						if ( iCursed != null )
						{
							...
							{
								m.LocalOverheadMessage(MessageType.Emote, 0x22, true, "A trap triggered, putting a curse on one of your equipped items!");
								m.FixedParticles( 0x374A, 10, 15, 5028, EffectLayer.Waist );
								m.PlaySound( 0x1E1 );
					...
					else if ( nTrapType == 14 && SavingThrow( m, "Physical" ) == false ) // FLOOR SPIKE TRAP
					{
						...
						m.LocalOverheadMessage(MessageType.Emote, 0x22, true, "You triggered a spike trap!");
						int itHurts = (int)( (Utility.RandomMinMax(50,200) * ( 100 - m.PhysicalResistance ) ) / 100 );
						m.Damage( itHurts, m );
						sTrapType = "a spike trap";

					}
					else if ( nTrapType == 15 && SavingThrow( m, "Physical" ) == false ) // SAW TRAP
					{
						...
						m.LocalOverheadMessage(MessageType.Emote, 0x22, true, "You triggered a saw blade trap!");
						int itHurts = (int)( (Utility.RandomMinMax(50,200) * ( 100 - m.PhysicalResistance ) ) / 100 );
						m.Damage( itHurts, m );
						sTrapType = "a saw blade trap";
					}
					else if ( nTrapType == 16 && SavingThrow( m, "Fire" ) == false ) // FLAME TRAP
					{
					...
					else if ( nTrapType == 17 && SavingThrow( m, "Physical" ) == false ) // GIANT SPIKE TRAP
					{
						Effects.SendLocationEffect( this.Location, this.Map, 0x1D99, 48, 2, 0, 0 );
						Effects.PlaySound( this.Location, this.Map, 0x22C );
						m.LocalOverheadMessage(MessageType.Emote, 0x22, true, "You triggered a giant spike trap!");
						int itHurts = (int)( (Utility.RandomMinMax(50,200) * ( 100 - m.PhysicalResistance ) ) / 100 );
						m.Damage( itHurts, m );
						sTrapType = "a giant spike trap";
					}
					else if ( nTrapType == 18 && SavingThrow( m, "Fire" ) == false ) // EXPLOSION TRAP
					{
					...
					else if ( nTrapType == 19 && SavingThrow( m, "Energy" ) == false ) // ELECTRICAL TRAP
					{
					...
					else if ( nTrapType == 20 && SavingThrow( m, "Agility" ) == false ) // TRIP WIRE THAT BREAKS ARROWS
					{
						List<Item> items = new List<Item>();
						int nBroken = 0;
					...
					else if ( nTrapType == 21 && SavingThrow( m, "Poison" ) == false ) // TAINTED TRAP
					{
						List<Item> items = new List<Item>();
						int nBroken = 0;
						int nAmount = 0;
						...
						if ( nAmount > 0 )
						{
							...
							Effects.SendLocationEffect( this.Location, this.Map, 0x11A8 - 2, 16, 3, 0, 0 );
							Effects.PlaySound( this.Location, this.Map, 0x231 );
							m.LocalOverheadMessage(MessageType.Emote, 0x22, true, "You walked into a noxious cloud, tainting your bandages!");

							sTrapType = "a noxious cloud trap";
						}
					}
					else if ( nTrapType == 22 && SavingThrow( m, "Agility" ) == false ) // TRIP WIRE THAT BREAKS POTIONS
					{
						List<Item> items = new List<Item>();
						int nBroken = 0;

						foreach( Item i in m.Backpack.FindItemsByType( typeof( BasePotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( AutoResPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( ShieldOfEarthPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( WoodlandProtectionPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( ProtectiveFairyPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( HerbalHealingPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( GraspingRootsPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( BlendWithForestPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( SwarmOfInsectsPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( VolcanicEruptionPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( TreefellowPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( StoneCirclePotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( DruidicRunePotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( LureStonePotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( NaturesPassagePotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( MushroomGatewayPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( RestorativeSoilPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( FireflyPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( HellsGateScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( ManaLeechScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( NecroCurePoisonScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( NecroPoisonScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( NecroUnlockScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( PhantasmScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( RetchedAirScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( SpectreShadowScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( UndeadEyesScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( VampireGiftScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( WallOfSpikesScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( BloodPactScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( GhostlyImagesScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( GhostPhaseScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( GraveyardGatewayScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( HellsBrandScroll ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( MagicalDyes ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( UnusualDyes ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( BottleOfAcid ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( CrystallineJar ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( NecroSkinPotion ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilWood ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilAmethyst ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilCaddellite ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilEmerald ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilGarnet ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilIce ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilJade ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilLeather ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilMarble ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilMetal ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilOnyx ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilQuartz ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilRuby ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilSapphire ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilSilver ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilSpinel ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilStarRuby ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilTopaz ), true ) ){ items.Add(i); nBroken = 1; }
						foreach( Item i in m.Backpack.FindItemsByType( typeof( OilWood ), true ) ){ items.Add(i); nBroken = 1; }
					...
					else if ( nTrapType == 23 && SavingThrow( m, "Magic" ) == false ) // MELT JEWELS TRAP
					{
						int puddle = 0;
			...
			if ( sTrapType == "a teleportation trap" || sTrapType == "an overcharged transporter pad" )
				return false;*/
		...
		public static bool IsJewelryItem( Item j )
		{
			...
			if ( j.ItemID == 0x108a
			 ...
			 || j.ItemID == 0x2B6F
			 || j.ItemID == 0x3166
			 || j.ItemID == 0x108B ){ IsJewelry = true; }
		...
		public static bool SavingThrow( Mobile m, string save )
		{
			bool madeSave = false;
			int SaveThrow = 0;
			...
			if ( SaveThrow >= Utility.RandomMinMax( 1, 100 ) ){ madeSave = true; }
		...
		public static int CheckTrapAvoidance( Mobile m, Item Trap )
		{
			...
			int trapChance = 0; // CHANCE A TRAP WILL GO OFF..SET TO 100 TO DISABLE ALL HIDDEN TRAPS
			if ( Trap is HiddenTrap ){ trapChance = 20; }
			...
			if ( m is PlayerMobile )
			{
				if ( m.Backpack != null && nSprung == 1 )
				{
					...
					if ( magicwand != null )
					{
						...
						if ( nPower >= Utility.RandomMinMax( 1, 100 ) && wands.owner == m )
						{
							if ( Trap is MushroomTrap )
							{
								m.LocalOverheadMessage(Network.MessageType.Emote, 0x3B2, false, "You got near a strange mushroom, but the magic of the wand has helped you avoid it.");
							}
							else
							{
								textSay = "You got near a hidden trap, but the magic of the wand has disabled it.";
								if ( Server.Misc.Worlds.IsOnSpaceship( m.Location, m.Map ) )
								{
									textSay = "You got near something dangerous, but the magic of the wand has helped you avoid it.";
								}
								m.LocalOverheadMessage(Network.MessageType.Emote, 0x3B2, false, textSay);
							}
							m.PlaySound( 0x1F0 );
				...
				if ( GetPlayerInfo.LuckyPlayer(m.Luck) && nSprung == 1 )
				{
					...
					else
					{
						...
						if ( Server.Misc.Worlds.IsOnSpaceship( m.Location, m.Map ) )
						{
							textSay = "You got near something dangerous, but with luck on your side...you avoid it.";
						}
						m.LocalOverheadMessage(Network.MessageType.Emote, 0x3B2, false, textSay);
						m.PlaySound( 0x241 );
					}
