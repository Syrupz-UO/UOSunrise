...
namespace Server.Items
{
	public class DDRelicOrbs : Item
	{
		...
		[Constructable]
		public DDRelicOrbs() : base( 0x227B )
		{
			...
			switch ( Utility.RandomMinMax( 0, 4 ) ) 
			{
				...
				case 1: ItemID = 0xE2D; Weight = 20; break;
				case 2: ItemID = 0x468A; Weight = 20; break;
				case 3: ItemID = 0x468B; Weight = 40; break;
				case 4: ItemID = 0x573E; Weight = 15; break;
			}
