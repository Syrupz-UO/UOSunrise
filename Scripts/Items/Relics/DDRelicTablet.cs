	...
	public class DDRelicTablet : Item
	{
		...
		public class TabletGump : Gump
		{
			public TabletGump( Mobile from, Item tablet ): base( 100, 100 )
			{
				...
				AddPage(0);
				AddImage(13, 13, 102);
				AddHtml( 61, 79, 133, 88, @"<BODY><BASEFONT Color=Black><BIG><CENTER>Somewhere in " + stone.SearchDungeon + " Lies an Artifact</CENTER></BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 38, 256, 181, 18, @"<BODY><BASEFONT Color=Black><BIG><CENTER>" + stone.SearchItem + "</CENTER></BIG></BASEFONT></CENTER></BODY>", (bool)false, (bool)false);
			}
		}
