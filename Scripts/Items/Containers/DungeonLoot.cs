...
namespace Server.Items
{
	public class DungeonLoot
	{
		...
		private static Type[] m_DungeonWareTypes = new Type[]
			{
				...
				typeof( HellishLeather ), typeof(PetLeash), typeof(MagicJewel),
		...
		private static Type[] m_DungeonRareTypes = new Type[]
			{
				...
				typeof( MyTentEastAddonDeed ),	typeof( HeavySharpeningStone ),		typeof( ConsecratedSharpeningStone ),
				...
				typeof( UnusualDyes ), typeof(MagicJewel),typeof(ScrollClue)
			};
		...
		private static Type[] m_DungeonSlayerTypes = new Type[]
			{
				typeof( SlayerDeed ), 			typeof( SlayerDeed ), 			typeof( LuckyHorseShoes ), typeof(LuckyHorseShoes25),typeof(LuckyHorseShoes50)
			};
