	...
	public class SalesBook : Item
	{
		...
		public class SalesBookGump : Gump
		{
			public SalesBookGump( Mobile from, SalesBook wikipedia, int page ): base( 100, 100 )
			{
				...
				AddHtml( 162, 64, 200, 34, @"<BODY><BASEFONT Color=Black><BIG><CENTER>" + BookTitle + "</CENTER></BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 444, 64, 180, 34, @"<BODY><BASEFONT Color=Black><BIG><CENTER>" + BookTitle + "</CENTER></BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 126, 112, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem1, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 148, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem2, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 184, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem3, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 220, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem4, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 256, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem5, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 292, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem6, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 328, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem7, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 126, 364, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem8, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

				if ( GetSalesForBook( m_Book.Name, showItem1, 1, from ) != "" ){ AddHtml( 328, 112, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem1, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem2, 1, from ) != "" ){ AddHtml( 328, 148, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem2, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem3, 1, from ) != "" ){ AddHtml( 328, 184, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem3, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem4, 1, from ) != "" ){ AddHtml( 328, 220, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem4, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem5, 1, from ) != "" ){ AddHtml( 328, 256, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem5, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem6, 1, from ) != "" ){ AddHtml( 328, 292, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem6, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem7, 1, from ) != "" ){ AddHtml( 328, 328, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem7, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem8, 1, from ) != "" ){ AddHtml( 328, 364, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem8, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				...
				AddHtml( 443, 112, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem9, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 148, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem10, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 184, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem11, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 220, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem12, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 256, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem13, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 292, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem14, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 328, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem15, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 443, 364, 240, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem16, 1, from ) + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

				if ( GetSalesForBook( m_Book.Name, showItem9, 1, from ) != "" ){ AddHtml( 645, 112, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem9, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem10, 1, from ) != "" ){ AddHtml( 645, 148, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem10, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem11, 1, from ) != "" ){ AddHtml( 645, 184, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem11, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem12, 1, from ) != "" ){ AddHtml( 645, 220, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem12, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem13, 1, from ) != "" ){ AddHtml( 645, 256, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem13, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem14, 1, from ) != "" ){ AddHtml( 645, 292, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem14, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem15, 1, from ) != "" ){ AddHtml( 645, 328, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem15, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
				if ( GetSalesForBook( m_Book.Name, showItem16, 1, from ) != "" ){ AddHtml( 645, 364, 70, 34, @"<BODY><BASEFONT Color=Black><BIG>" + GetSalesForBook( m_Book.Name, showItem16, 3, from ) + "G</BIG></BASEFONT></BODY>", (bool)false, (bool)false); }
		...
		public static string GetSalesForBook( string book, int selling, int part, Mobile player )
		{
			...
			if ( book == "Steel Crafted Items" || book == "Mithril Crafted Items" || book == "Brass Crafted Items" )
			{
				...
				if ( selling == sales ) { name="BoneHarvester"; item="Bone Harvester"; cost = 35; } sales++;
				...
				if ( selling == sales ) { name="OrcHelm"; item="Orc Helm"; cost = 24; } sales++;
				...
				if ( selling == sales ) { name="VikingSword"; item="Viking Sword"; cost = 55; } sales++;
