...
namespace Server.Items
{
	...
	{
		[Constructable]
		public LearnLeatherBook( ) : base( 0x2D9F )
		{
			Weight = 1.0;
		...
		public class LearnLeatherGump : Gump
		{
			public LearnLeatherGump( Mobile from ): base( 25, 25 )
			{
				...
				AddItem(602, 126, 3997);
				AddItem(308, 114, 4216);
				AddItem(833, 109, 4219);

				AddHtml( 170, 70, 600, 21, @"<BODY><BASEFONT Color=White><BIG>INFORMATION ON VARIOUS TYPES OF LEATHER</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
