...
namespace Server.Items
{
	...
	{
		[Constructable]
		public LearnMiscBook( ) : base( 0x2D9F )
		{
			Weight = 1.0;
		...
		public class LearnMiscGump : Gump
		{
			public LearnMiscGump( Mobile from ): base( 25, 25 )
			{
				...
				AddHtml( 187, 80, 316, 24, @"<BODY><BASEFONT Color=White><BIG>SKINNING ANIMALS & CREATURES</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
