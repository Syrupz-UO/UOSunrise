...
namespace Server.Items
{
	...
	{
		[Constructable]
		public LearnTailorBook( ) : base( 0x2D9F )
		{
			Weight = 1.0;
		...
		public class LearnTailorGump : Gump
		{
			public LearnTailorGump( Mobile from ): base( 25, 25 )
			{
				...
				AddHtml( 187, 80, 316, 24, @"<BODY><BASEFONT Color=White><BIG>BASIC GUIDE TO TAILORING</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
