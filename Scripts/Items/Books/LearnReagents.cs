...
namespace Server.Items
{
	...
	{
		[Constructable]
		public LearnReagentsBook( ) : base( 0x2D9F )
		{
			Weight = 1.0;
		...
		public class LearnReagentsGump : Gump
		{
			public LearnReagentsGump( Mobile from ): base( 25, 25 )
			{
				...
				AddImage(230, 46, 132);
				AddImage(530, 46, 132);
				AddHtml( 170, 70, 420, 21, @"<BODY><BASEFONT Color=White><BIG>INFORMATION ON VARIOUS REAGENTS</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 147, 114, 137, 21, @"<BODY><BASEFONT Color=White><BIG>Common</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 147, 488, 137, 21, @"<BODY><BASEFONT Color=#FCFF00><BIG>Daemon Blood</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddItem(96, 488, 3965);
				AddImage(98, 420, 143);
				AddHtml( 147, 420, 137, 21, @"<BODY><BASEFONT Color=White><BIG>Necromancer</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 366, 114, 137, 21, @"<BODY><BASEFONT Color=White><BIG>Unusual</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				...
				AddHtml( 366, 590, 137, 21, @"<BODY><BASEFONT Color=White><BIG>Other</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddItem(635, 71, 8787);
				AddItem(597, 72, 3739);
				AddItem(678, 72, 3854);
				AddItem(761, 73, 9578);
