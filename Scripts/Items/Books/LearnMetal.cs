...
namespace Server.Items
{
	...
	{
		[Constructable]
		public LearnMetalBook( ) : base( 0x2D9F )
		{
			Weight = 1.0;
		...
		public class LearnMetalGump : Gump
		{
			public LearnMetalGump( Mobile from ): base( 25, 25 )
			{
				...
				AddHtml( 170, 70, 600, 21, @"<BODY><BASEFONT Color=White><BIG>INFORMATION ON VARIOUS TYPES OF METAL</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
