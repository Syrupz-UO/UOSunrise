		...
		public override void OnSpeech( SpeechEventArgs e )
		{
			if ( !e.Handled )
			{
				...
				else if ( this.Name != "Magic Forge Trigger" ) // DEATH KNIGHT SHRINES
				{
					...
					{
						string skull = "DeathKnightSkull750";

						if ( this.Name == "Kath" ){ skull = "DeathKnightSkull752"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull752 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
						else if ( this.Name == "Farian" ){ skull = "DeathKnightSkull755"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull755 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
						else if ( this.Name == "Kargoth" ){ skull = "DeathKnightSkull750"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull750 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
						else if ( this.Name == "Maeril" ){ skull = "DeathKnightSkull754"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull754 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
						else if ( this.Name == "Myrhal" ){ skull = "DeathKnightSkull753"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull753 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
						else if ( this.Name == "Monduiz" ){ skull = "DeathKnightSkull751"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull751 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
						else if ( this.Name == "Androma" ){ skull = "DeathKnightSkull756"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull756 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
						else if ( this.Name == "Thyrian" ){ skull = "DeathKnightSkull759"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull759 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
						else if ( this.Name == "Rezinar" ){ skull = "DeathKnightSkull758"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull758 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
						else if ( this.Name == "Minar" ){ skull = "DeathKnightSkull760"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull760 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
						else if ( this.Name == "Luren" ){ skull = "DeathKnightSkull762"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull762 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
						else if ( this.Name == "Urkar" ){ skull = "DeathKnightSkull761"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull761 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
						else if ( this.Name == "Khayven" ){ skull = "DeathKnightSkull763"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull763 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
						else if ( this.Name == "Oslan" ){ skull = "DeathKnightSkull757"; ArrayList targets = new ArrayList(); foreach ( Item item in World.Items.Values ) { if ( item is DeathKnightSkull757 ) { targets.Add( item ); } } for ( int i = 0; i < targets.Count; ++i ) { Item item = ( Item )targets[ i ]; item.Delete(); } }
