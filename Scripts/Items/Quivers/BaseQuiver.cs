...
namespace Server.Items
{
	...
	public class BaseQuiver : Container, ICraftable
	{
		...
		{
			typeof( Arrow ), typeof( Bolt ), typeof( ALightningArrow  ),typeof( FreezeArrow  ),typeof( ExplosiveArrow  ),typeof( PoisonArrow  ),typeof( ArmorPiercingArrow  ),
			typeof( LightningBolt2  ),typeof( FreezeBolt  ),typeof( ExplosiveBolt  ),typeof( PoisonBolt  ),typeof( ArmorPiercingBolt  )
		};
