...
{ 
	public class HolyManSpellbookGump : Gump 
	{
		...
		public HolyManSpellbookGump( Mobile from, HolyManSpellbook book, int page ) : base( 100, 100 ) 
		{
			...
			AddHtml( 172, 61, 345, 31, @"<BODY><BASEFONT Color=Black><BIG><CENTER>Prayer Book                 Prayer Book</CENTER></BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 2 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>Sends demons and the dead back to the realms of hell.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 3 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>Absorbs mana from others and bestows it to the priest.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 4 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>Temporarily imbues a weapon with holy powers.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 5 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>Temporarily summons a hammer from the gods.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 6 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>Destroys the darkness, allowing for one to see better.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 7 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>The priest is able to help those that are starving or thirsty.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 8 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>Removes curses and other ailing effects.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 9 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>Brings one back to life, or summons an orb to resurrect the priest later on.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 10 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>Surrounds one with a holy aura that heals wounds much quicker.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 11 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>The gods grant the priest greater strength, speed, and intelligence.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 12 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>Allows the priest to enter the realm of the dead, avoiding any harm.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 13 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>Calls down a bolt from the heavens, doing double damage to demons and undead.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 14 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>Restores health and stamina to the weary.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 15 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>Engulfs the priest in holy flames, reflecting magic back at the caster.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			...
			else if ( page == 18 )
			{
				...
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>[holyspell1 - Opens the 1st priest spell bar editor.<br>[holyspell2 - Opens the 2nd priest spell bar editor.<br><br><br>[holytool1 - Opens the 1st priest spell bar.<br>[holytool2 - Opens the 2nd priest spell bar.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			}
			else if ( page == 19 )
			{
				AddHtml( 128, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG>[holyclose1 - Closes the 1st priest spell bar.<br>[holyclose2 - Closes the 2nd priest spell bar.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				AddHtml( 361, 99, 201, 223, @"<BODY><BASEFONT Color=Black><BIG></BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			}
		}
