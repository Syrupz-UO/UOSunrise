...
namespace Server.Spells.Spellweaving
{
	public class ArcaneCircleSpell : ArcanistSpell
	{
		...
		{
			return (m == Map.Trammel || m == Map.Felucca) && p.X == 1829 && p.Y == 774;
		}
		...
		public static bool IsValidTile( int itemID )
		{
			...
			return (itemID == 0x307B || itemID == 0x1216 || itemID == 0x307F || itemID == 0x1D10 || itemID == 0x1D0F || itemID == 0x1D1F || itemID == 0x1D12 );	// Pentagram center, Abbatoir center, Arcane Circle Center, Bloody Pentagram has 4 tiles at center
		}
