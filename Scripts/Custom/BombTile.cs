...
using Server.Mobiles;
   ...
   Written by Alari
    ...
    based off SimpleSwitch. (did a search and replace on simpleswitch->BombTile
...
namespace Server.Items
{
	...
	public class BombTile : Item
	{
		...
		public BombTile( Serial serial ) : base( serial )
		{
		}
