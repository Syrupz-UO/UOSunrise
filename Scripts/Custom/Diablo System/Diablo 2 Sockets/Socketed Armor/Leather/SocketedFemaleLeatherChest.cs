...
{
	public class SocketedFemaleLeatherChest : FemaleLeatherChest
	{
		[Constructable]
		public SocketedFemaleLeatherChest()
		{
			UsedSockets = 0;
		...
		public SocketedFemaleLeatherChest( Serial serial ) : base( serial )
		{
		}
