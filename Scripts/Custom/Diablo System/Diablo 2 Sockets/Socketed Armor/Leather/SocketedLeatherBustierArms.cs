...
{
	public class SocketedLeatherBustierArms : LeatherBustierArms
	{
		[Constructable]
		public SocketedLeatherBustierArms()
		{
			UsedSockets = 0;
		...
		public SocketedLeatherBustierArms( Serial serial ) : base( serial )
		{
		}
