...
{
	public class SocketedStuddedBustierArms : StuddedBustierArms
	{
		[Constructable]
		public SocketedStuddedBustierArms()
		{
			UsedSockets = 0;
		...
		public SocketedStuddedBustierArms( Serial serial ) : base( serial )
		{
		}
