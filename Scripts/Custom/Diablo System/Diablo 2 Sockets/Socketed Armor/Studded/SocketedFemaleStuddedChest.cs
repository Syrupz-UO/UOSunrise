...
{
	public class SocketedFemaleStuddedChest : FemaleStuddedChest
	{
		[Constructable]
		public SocketedFemaleStuddedChest()
		{
			UsedSockets = 0;
		...
		public SocketedFemaleStuddedChest( Serial serial ) : base( serial )
		{
		}
