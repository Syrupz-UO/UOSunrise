...
{
	public class SocketedDecorativePlateKabuto : DecorativePlateKabuto
	{
		[Constructable]
		public SocketedDecorativePlateKabuto()
		{
			UsedSockets = 0;
        ...
        public SocketedDecorativePlateKabuto(Serial serial)
            : base(serial)
		{
		}
