...
{
	public class PlainAmethyst : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public PlainAmethyst() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a plain amethyst";
			Hue = 15;
		}
		...
		{ 
			private PlainAmethyst m_Augmentation; 
		
			public InternalTarget( PlainAmethyst augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
		...
		public PlainAmethyst( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +20% Dmg - A +3 Str - S +20% Def\t " );
		}
