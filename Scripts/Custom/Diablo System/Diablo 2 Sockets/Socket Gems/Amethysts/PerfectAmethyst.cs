...
{
	public class PerfectAmethyst : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public PerfectAmethyst() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a perfect amethyst";
			Hue = 1168;
		}
		...
		{ 
			private PerfectAmethyst m_Augmentation; 
		
			public InternalTarget( PerfectAmethyst augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Shield.MaterialType == ArmorMaterialType.Plate ) 
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Shield.Attributes.DefendChance += 30;
								Shield.Hue = 1168;
		...
		public PerfectAmethyst( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +30% Dmg - A +5 Str - S +30% Def\t " );
		}
