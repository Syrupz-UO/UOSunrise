...
{
	public class ChippedAmethyst : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public ChippedAmethyst() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a chipped amethyst";
			Hue = 13;
		}
		...
		{ 
			private ChippedAmethyst m_Augmentation; 
		
			public InternalTarget( ChippedAmethyst augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
		...
		public ChippedAmethyst( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +10% Dmg - A +1 Str - S +10% Def\t " );
		}
