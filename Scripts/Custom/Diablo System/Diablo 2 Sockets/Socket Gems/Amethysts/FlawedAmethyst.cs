...
{
	public class FlawedAmethyst : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public FlawedAmethyst() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a flawed amethyst";
			Hue = 14;
		}
		...
		{ 
			private FlawedAmethyst m_Augmentation; 
		
			public InternalTarget( FlawedAmethyst augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
		...
		public FlawedAmethyst( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +15% Dmg - A +2 Str - S +15% Def\t " );
		}
