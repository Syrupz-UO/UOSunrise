...
{
	public class FlawlessAmethyst : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public FlawlessAmethyst() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a flawless amethyst";
			Hue = 16;
		}
		...
		{ 
			private FlawlessAmethyst m_Augmentation; 
		
			public InternalTarget( FlawlessAmethyst augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
		...
		public FlawlessAmethyst( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +25% Dmg - A +4 Str - S +25% Def\t " );
		}
