...
{
	public class PlainRuby : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public PlainRuby() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a plain ruby";
		...
		{ 
			private PlainRuby m_Augmentation; 
		
			public InternalTarget( PlainRuby augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitFireArea += 20;
								Weapon.Hue = 35;			                  
		...
		public PlainRuby( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +20% FireArea - A +3 HP - S +6% FireRes\t " );
		}
