...
{
	public class PerfectRuby : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public PerfectRuby() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a perfect ruby";
		...
		{ 
			private PerfectRuby m_Augmentation; 
		
			public InternalTarget( PerfectRuby augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitFireArea += 30;
								Weapon.Hue = 1166;			                  
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +30% FireArea - A +5 HP - S +10% FireRes\t " );
		}
