...
{
	public class FlawedRuby : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public FlawedRuby() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a flawed ruby";
		...
		{ 
			private FlawedRuby m_Augmentation; 
		
			public InternalTarget( FlawedRuby augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitFireArea += 15;
								Weapon.Hue = 34;			                  
		...
		public FlawedRuby( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +15% FireArea - A +2 HP - S +4% FireRes\t " );
		}
