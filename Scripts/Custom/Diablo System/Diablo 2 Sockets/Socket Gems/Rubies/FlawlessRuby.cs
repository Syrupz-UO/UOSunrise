...
{
	public class FlawlessRuby : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public FlawlessRuby() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a flawless ruby";
			Hue = 36;
		}
		...
		{ 
			private FlawlessRuby m_Augmentation; 
		
			public InternalTarget( FlawlessRuby augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
		...
		public FlawlessRuby( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +25% FireArea - A +4 HP - S +8% FireRes\t " );
		}
