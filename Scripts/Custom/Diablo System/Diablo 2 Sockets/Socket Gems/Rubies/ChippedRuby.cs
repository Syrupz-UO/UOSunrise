...
{
	public class ChippedRuby : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public ChippedRuby() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a chipped ruby";
		...
		{ 
			private ChippedRuby m_Augmentation; 
		
			public InternalTarget( ChippedRuby augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
		...
		public ChippedRuby( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +10% FireArea - A +1 HP - S +2% FireRes\t " );
		}
