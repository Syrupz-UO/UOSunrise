...
{
	public class FlawedSkull : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public FlawedSkull() : base( 6884 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a flawed skull";
		...
		{ 
			private FlawedSkull m_Augmentation; 
		
			public InternalTarget( FlawedSkull augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitLeechHits += 2;
								Weapon.WeaponAttributes.HitLeechMana += 2;
								Weapon.Hue = 1000;			                  
		...
		public FlawedSkull( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \t+W 2% Life & Mana Leech - A +2% HPRegen & ManaRegen - S +10% Reflect\t " );
		}
