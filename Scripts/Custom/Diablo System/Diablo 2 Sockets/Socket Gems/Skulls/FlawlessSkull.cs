...
{
	public class FlawlessSkull : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public FlawlessSkull() : base( 6884 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a flawless skull";
			Hue = 998;
		}
		...
		{ 
			private FlawlessSkull m_Augmentation; 
		
			public InternalTarget( FlawlessSkull augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitLeechMana += 4;
								Weapon.Hue = 998;			                  
		...
		public FlawlessSkull( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +4% Life & Mana Leech - A +4% HPRegen & ManaRegen - S +20% Reflect\t " );
		}
