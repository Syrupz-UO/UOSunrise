...
{
	public class ChippedSkull : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public ChippedSkull() : base( 6884 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a chipped skull";
			Hue = 1001;
		}
		...
		{ 
			private ChippedSkull m_Augmentation; 
		
			public InternalTarget( ChippedSkull augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitLeechHits += 1;
								Weapon.WeaponAttributes.HitLeechMana += 1;
								Weapon.Hue = 1001;			                  
		...
		public ChippedSkull( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +1% Life & Mana Leech - A +1% HPRegen & ManaRegen - S +5% Reflect\t " );
		}
