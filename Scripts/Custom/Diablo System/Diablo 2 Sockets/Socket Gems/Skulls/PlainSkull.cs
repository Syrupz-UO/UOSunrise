...
{
	public class PlainSkull : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public PlainSkull() : base( 6884 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a plain skull";
		...
		{ 
			private PlainSkull m_Augmentation; 
		
			public InternalTarget( PlainSkull augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitLeechHits += 3;
								Weapon.WeaponAttributes.HitLeechMana += 3;
								Weapon.Hue = 999;			                  
		...
		public PlainSkull( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +3% Life & Mana Leech - A +3% HPRegen & ManaRegen - S +15% Reflect\t " );
		}
