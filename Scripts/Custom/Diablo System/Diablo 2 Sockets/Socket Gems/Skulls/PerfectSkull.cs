...
namespace Server.Items
{
	public class PerfectSkull : Item
	{
		...
		{ 
			private PerfectSkull m_Augmentation; 
		
			public InternalTarget( PerfectSkull augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitLeechHits += 5;
								Weapon.WeaponAttributes.HitLeechMana += 5;
								Weapon.Hue = 1109;			                  
					...
					else if ( Shield.MaterialType == ArmorMaterialType.Plate ) 
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Shield.Attributes.ReflectPhysical += 25;
								Shield.Hue = 1109;			                  
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +5% Life & Mana Leech - A +5% HPRegen & ManaRegen - S +25% Ref-Phy\t " );
		}
