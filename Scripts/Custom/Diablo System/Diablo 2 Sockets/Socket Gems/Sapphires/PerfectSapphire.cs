...
{
	public class PerfectSapphire : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public PerfectSapphire() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a perfect sapphire";
			Hue = 1165;
		}
		...
		{ 
			private PerfectSapphire m_Augmentation; 
		
			public InternalTarget( PerfectSapphire augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitColdArea += 30;
								Weapon.Hue = 1165;			                  
		...
		public PerfectSapphire( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +30% ColdArea - A +5 Mana - S +10% ColdRes\t " );
		}
