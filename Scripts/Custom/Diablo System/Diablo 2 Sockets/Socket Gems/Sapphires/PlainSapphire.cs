...
{
	public class PlainSapphire : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public PlainSapphire() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a plain sapphire";
			Hue = 5;
		}
		...
		{ 
			private PlainSapphire m_Augmentation; 
		
			public InternalTarget( PlainSapphire augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
		...
		public PlainSapphire( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +20% ColdArea - A +3 Mana - S +6% ColdRes\t " );
		}
