...
{
	public class FlawedSapphire : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public FlawedSapphire() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a flawed sapphire";
			Hue = 4;
		}
		...
		{ 
			private FlawedSapphire m_Augmentation; 
		
			public InternalTarget( FlawedSapphire augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
		...
		public FlawedSapphire( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +15% ColdArea - A +2 Mana - S +4% ColdRes\t " );
		}
