...
{
	public class ChippedSapphire : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public ChippedSapphire() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a chipped sapphire";
			Hue = 2;
		}
		...
		{ 
			private ChippedSapphire m_Augmentation; 
		
			public InternalTarget( ChippedSapphire augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitColdArea += 10;
								Weapon.Hue = 2;			                  
		...
		public ChippedSapphire( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +10% ColdArea - A +1 Mana - S +2% ColdRes\t " );
		}
