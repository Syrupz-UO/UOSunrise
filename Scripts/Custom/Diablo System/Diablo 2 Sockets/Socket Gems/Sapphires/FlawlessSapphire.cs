...
{
	public class FlawlessSapphire : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public FlawlessSapphire() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a flawless sapphire";
			Hue = 6;
		}
		...
		{ 
			private FlawlessSapphire m_Augmentation; 
		
			public InternalTarget( FlawlessSapphire augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitColdArea += 25;
								Weapon.Hue = 6;			                  
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +25% ColdArea - A +4 Mana - S +8% ColdRes\t " );
		}
