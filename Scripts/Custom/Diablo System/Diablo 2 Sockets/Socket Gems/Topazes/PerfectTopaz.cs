...
{
	public class PerfectTopaz : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public PerfectTopaz() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a perfect topaz";
			Hue = 1169;
		}
		...
		{ 
			private PerfectTopaz m_Augmentation; 
		
			public InternalTarget( PerfectTopaz augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitEnergyArea += 30;
								Weapon.Hue = 1169;			                  
		...
		public PerfectTopaz( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +30% NrgyArea - A +50Luck - S +10% NrgyRes\t " );
		}
