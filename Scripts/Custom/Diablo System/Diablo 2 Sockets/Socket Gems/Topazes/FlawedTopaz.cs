...
{
	public class FlawedTopaz : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public FlawedTopaz() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a flawed topaz";
		...
		{ 
			private FlawedTopaz m_Augmentation; 
		
			public InternalTarget( FlawedTopaz augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitEnergyArea += 15;
								Weapon.Hue = 49;			                  
		...
		public FlawedTopaz( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +15% NrgyArea - A +20 Luck - S +4% NrgyRes\t " );
		}
