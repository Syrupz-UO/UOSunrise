...
{
	public class PlainTopaz : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public PlainTopaz() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a plain topaz";
		...
		{ 
			private PlainTopaz m_Augmentation; 
		
			public InternalTarget( PlainTopaz augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitEnergyArea += 20;
								Weapon.Hue = 50;			                  
		...
		public PlainTopaz( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +20% NrgyArea - A +30 Luck - S +6% NrgyRes\t " );
		}
