...
{
	public class FlawlessTopaz : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public FlawlessTopaz() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a flawless topaz";
			Hue = 51;
		}
		...
		{ 
			private FlawlessTopaz m_Augmentation; 
		
			public InternalTarget( FlawlessTopaz augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitEnergyArea += 25;
								Weapon.Hue = 51;			                  
		...
		public FlawlessTopaz( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +25% NrgyArea - A +40 Luck - S +8% NrgyRes\t " );
		}
