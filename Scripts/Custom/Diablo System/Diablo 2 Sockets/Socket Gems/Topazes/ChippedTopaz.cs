...
{
	public class ChippedTopaz : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public ChippedTopaz() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a chipped topaz";
			Hue = 48;
		}
		...
		{ 
			private ChippedTopaz m_Augmentation; 
		
			public InternalTarget( ChippedTopaz augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitEnergyArea += 10;
								Weapon.Hue = 48;			                  
		...
		public ChippedTopaz( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +10% NrgyArea - A +10 Luck - S +2% NrgyRes\t " );
		}
