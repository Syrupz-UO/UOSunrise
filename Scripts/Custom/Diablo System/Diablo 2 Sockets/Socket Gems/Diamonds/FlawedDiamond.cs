...
{
	public class FlawedDiamond : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public FlawedDiamond() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a flawed diamond";
			Hue = 2407;
		}
		...
		{ 
			private FlawedDiamond m_Augmentation; 
		
			public InternalTarget( FlawedDiamond augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitPhysicalArea += 15;
								Weapon.Hue = 2407;			                  
					...
					|| Armor.BodyPosition == ArmorBodyType.Chest ) 
					{
						...
						{  
							...
							else
							{
								...
								{
									Armor.UsedSockets += 1;
									Armor.Attributes.AttackChance += 3;
									Armor.Hue = 2407;			                  
		...
		public FlawedDiamond( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +15% PhysArea - A +3% Hit - S +2% AllRes\t " );
		}
