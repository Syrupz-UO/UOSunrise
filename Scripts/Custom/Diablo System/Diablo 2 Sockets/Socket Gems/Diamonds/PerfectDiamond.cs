...
{
	public class PerfectDiamond : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public PerfectDiamond() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a perfect diamond";
			Hue = 1150;
		}
		...
		{ 
			private PerfectDiamond m_Augmentation; 
		
			public InternalTarget( PerfectDiamond augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitPhysicalArea += 30;
								Weapon.Hue = 1150;			                  
					...
					|| Armor.BodyPosition == ArmorBodyType.Chest ) 
					{
						...
						{  
							...
							else
							{
								...
								{
									Armor.UsedSockets += 1;
									Armor.Attributes.AttackChance += 6;
									Armor.Hue = 1150;			                  
		...
		public PerfectDiamond( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +30% PhysArea - A +6% Hit - S +5% AllRes\t " );
		}
