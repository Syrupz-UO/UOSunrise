...
{
	public class PerfectDiabloEmerald : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public PerfectDiabloEmerald() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a perfect emerald";
			Hue = 1167;
		}
		...
		{ 
			private PerfectDiabloEmerald m_Augmentation; 
		
			public InternalTarget( PerfectDiabloEmerald augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitPoisonArea += 30;
								Weapon.Hue = 1167;			                  
		...
		public PerfectDiabloEmerald( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +30% PoisArea - A +5 Dex - S +10% PoisRes\t " );
		}
