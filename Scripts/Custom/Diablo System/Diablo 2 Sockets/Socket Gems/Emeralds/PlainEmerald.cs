...
{
	public class PlainEmerald : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public PlainEmerald() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a plain emerald";
			Hue = 68;
		}
		...
		{ 
			private PlainEmerald m_Augmentation; 
		
			public InternalTarget( PlainEmerald augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitPoisonArea += 20;
								Weapon.Hue = 68;			                  
		...
		public PlainEmerald( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +20% PoisArea - A +3 Dex - S +6% PoisRes\t " );
		}
