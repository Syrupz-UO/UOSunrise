...
{
	public class FlawedEmerald : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public FlawedEmerald() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a flawed emerald";
			Hue = 167;
		}
		...
		{ 
			private FlawedEmerald m_Augmentation; 
		
			public InternalTarget( FlawedEmerald augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
		...
		public FlawedEmerald( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \t+W 15% PoisArea - A +2 Dex - S +4% PoisRes\t " );
		}
