...
{
	public class FlawlessEmerald : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public FlawlessEmerald() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a flawless emerald";
			Hue = 71;
		}
		...
		{ 
			private FlawlessEmerald m_Augmentation; 
		
			public InternalTarget( FlawlessEmerald augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
					...
					else if ( Weapon.Type == WeaponType.Ranged )
					{
						...
						else
						{
							...
							if ( EnhanceChance == 0 ) // Success
							{
								...
								Weapon.WeaponAttributes.HitPoisonArea += 25;
								Weapon.Hue = 71;			                  
		...
		public FlawlessEmerald( Serial serial ) : base( serial )
		{
		}
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +25% PoisArea - A +4 Dex - S +8% PoisRes\t " );
		}
