...
{
	public class ChippedEmerald : Item
	{
		private string m_ModifierList;
	
		[Constructable]
		public ChippedEmerald() : base( 7847 )
		{
			Stackable = true;
			Weight = 1;
			Name = "a chipped emerald";
			Hue = 467;
		}
		...
		{ 
			private ChippedEmerald m_Augmentation; 
		
			public InternalTarget( ChippedEmerald augmentation ) : base( 1, false, TargetFlags.None ) 
			{ 
		...
		public ChippedEmerald( Serial serial ) : base( serial )
		{
		}		
		...
		public override void GetProperties( ObjectPropertyList list )
		{
			...
			list.Add( 1050045," \tW +5% PoisArea - A +3 Dex - S +3% PoisRes\t " );
		}
