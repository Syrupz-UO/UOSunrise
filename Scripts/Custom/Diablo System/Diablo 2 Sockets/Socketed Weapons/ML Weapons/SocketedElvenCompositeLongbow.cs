...
{
	public class SocketedElvenCompositeLongbow : ElvenCompositeLongbow
	{
		[Constructable]
		public SocketedElvenCompositeLongbow()
		{
			UsedSockets = 0;
        ...
        public SocketedElvenCompositeLongbow(Serial serial)
            : base(serial)
		{
		}
