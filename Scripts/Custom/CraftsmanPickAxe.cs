...
namespace Server.Items
{
	...
	public class CraftsmanPickaxe : BaseAxe, IUsesRemaining
	{
		...
		[Constructable]
		public CraftsmanPickaxe() : base( 0xE86 )
		{
			Weight = 11.0;
			UsesRemaining = 1500;
			ShowUsesRemaining = true;
			Hue=2080;
			Name="Craftsman Pickaxe";
		}

		public CraftsmanPickaxe( Serial serial ) : base( serial )
		{
		}
