...
namespace Server
{
    public class SkilllimPickGump100 : Gump
    {


        private int switches = 1;
        private SkillBall100 m_SkillBall;
        private double val = 100;


        public SkilllimPickGump100(SkillBall100 ball)
            : base(0, 0)
        {
            this.Closable = true;
            ...
            this.AddLabel(67, 41, 1153, @"Please select your 1 skill");
                ...
                case 1:
                    {
                        ...
                        {
                            m.SendGump(new SkilllimPickGump100(m_SkillBall));
                        ...
                        {
                            m.SendGump(new SkilllimPickGump100(m_SkillBall));
                            m.SendMessage(0, "Please get rid of {0} skills, you have exceeded the 5 skills that are allowed.", info.Switches.Length - switches);
                            break;
    ...
    public class SkillBall100 : Item
    {
        [Constructable]
        public SkillBall100()
            : base(0xE73)
        ...
        public override void OnDoubleClick(Mobile m)
        {
            ...
            if (m.Backpack != null && m.Backpack.GetAmount(typeof(SkillBall100)) > 0)
            {
                m.SendMessage("Please choose  your 5 skills to set to 100.");
                m.CloseGump(typeof(SkilllimPickGump100));
                m.SendGump(new SkilllimPickGump100(this));
            }
            else
        ...
        public SkillBall100(Serial serial)
            : base(serial)
        {
        }
