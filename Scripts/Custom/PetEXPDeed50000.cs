...
{ 
   	public class PetEXPDeed50000 : Item 
   	{     
      	[Constructable] 
      	public PetEXPDeed50000() : base( 0x14F0 )
      	{ 
         	Movable = true;
			Hue = 1050;
		...
		public PetEXPDeed50000( Serial serial ) : base( serial ) 
		{ 
		}
		...
		{ 
			...
			else if( from.InRange( this.GetWorldLocation(), 2 ) ) 
			{
				...
				from.Target = new PetEXPTarget50000( this );
			} 
			else 
			{ 
        ...
        public override void GetProperties( ObjectPropertyList list )
        {
            ...
            list.Add( "<BASEFONT COLOR=#7FCAE7>Value:" + "<BASEFONT COLOR=#FFFFFF> 50.000" + "<BASEFONT COLOR=#7FCAE7> Effects:" + "<BASEFONT COLOR=#FFFFFF> Increases Pet Experience");	
        }
		...
		{ 
  		...
  		private class PetEXPTarget50000 : Target 
		{ 
			private Mobile m_Owner; 
			private Item m_Deed; 

			public PetEXPTarget50000( Item deed ) : base ( 10, false, TargetFlags.None ) 
			{ 
				m_Deed = deed; 
			} 
			...
			{ 
				...
				{ 
					...
					else if ( c.NextLevel <=50000 ) // HORUS
					{
