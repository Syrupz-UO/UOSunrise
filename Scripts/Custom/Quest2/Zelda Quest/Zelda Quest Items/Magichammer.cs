...
{
	public class MagicHammer2 : Item
	{
		[Constructable]
		public MagicHammer2() : base( 0x0FB4 )
		{
			Name = "a Magic Hammer";
			Hue = 0x430;
			Weight = 1.0;
		...
		public MagicHammer2( Serial serial ) : base( serial )
		{
		}
		...
		{
			private MagicHammer2 m_Item;

			public InternalTarget( MagicHammer2 item ) : base( 1, false, TargetFlags.None )
			{
				m_Item = item;
			}
