...
"<BASEFONT COLOR=YELLOW>Next we must find the Great Fairy Sword, This one may be hard to find. Rumors are that it is hidden in the Underworld, where ever that may be.<BR><BR>" +			
