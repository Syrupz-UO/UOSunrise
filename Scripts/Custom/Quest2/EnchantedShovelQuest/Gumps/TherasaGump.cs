...
"<BASEFONT COLOR=YELLOW>The first piece I know is somewhere in Despise.<BR><BR> There are quite a few monsters there, so you will have to be brave and kill them all.<BR>The Second is somewhere in Undermountain, I think...<BR><BR>" +
"<BASEFONT COLOR=YELLOW>The Third and Final piece can be found in Hythloth, be careful.<BR><BR>" +
