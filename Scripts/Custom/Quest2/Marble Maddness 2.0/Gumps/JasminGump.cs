...
"<BASEFONT COLOR=YELLOW>Then the Lizardmen all ran back to their lair.<BR><BR>But I'm too scared to go back down there in case the Lizardmen are hiding and waiting for me - they could catch me and eat me all up<BR>" +
"<BASEFONT COLOR=YELLOW>Will you make sure that the dungeon is clear and safe?, And if you can, get back some of the marbles that were stolen, the Lizardmen should still be carrying them and I would love to have them back - especially the big colourful one that was a present from my best friend.<BR><BR>" +
"<BASEFONT COLOR=YELLOW>Head into the dungeon and kill the lizardmen until you get the big colourful marble.<BR><BR>" +
