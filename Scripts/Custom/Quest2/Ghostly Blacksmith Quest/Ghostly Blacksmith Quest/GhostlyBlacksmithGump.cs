...
"<BASEFONT COLOR=YELLOW>The Charcoal will be on Ravendark Island... or as some call it, the Island of Dracula.<BR>" +
"<BASEFONT COLOR=YELLOW>And the Sosarian Ore in Caddelite <BR>" +
"<BASEFONT COLOR=YELLOW>Crater.'<BR>" +
"<BASEFONT COLOR=YELLOW> <BR>" +
