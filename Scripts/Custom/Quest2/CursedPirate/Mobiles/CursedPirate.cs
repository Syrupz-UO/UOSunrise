...
namespace Server.Mobiles
{
	...
	public class CursedPirate : BaseCreature
	{
		...
		public CursedPirate() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			SetSkill( SkillName.Fencing, 56.0, 97.5 );
			SetSkill( SkillName.Macing, 45.0, 87.5 );
			SetSkill( SkillName.MagicResist, 63.5, 102.5 );
			SetSkill( SkillName.Swords, 75.0, 107.5 );
			SetSkill( SkillName.Tactics, 80.0, 112.5 );
			SetSkill( SkillName.Poisoning, 70.0, 92.5 );
