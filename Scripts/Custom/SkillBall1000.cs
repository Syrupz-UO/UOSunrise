...
namespace Server
{
    public class SkilllimPickGump1000 : Gump
    {


        private int switches = 10;
        private SkillBall1000 m_SkillBall;
        private double val = 100;


        public SkilllimPickGump1000(SkillBall1000 ball)
            : base(0, 0)
        {
            this.Closable = true;
                ...
                case 1:
                    {
                        ...
                        {
                            m.SendGump(new SkilllimPickGump1000(m_SkillBall));
    ...
    public class SkillBall1000 : Item
    {
        [Constructable]
        public SkillBall1000()
            : base(0xE73)
        {
            Weight = 1.0;
            Hue = 105;
        ...
        public override void OnDoubleClick(Mobile m)
        {
            ...
            if (m.Backpack != null && m.Backpack.GetAmount(typeof(SkillBall1000)) > 0)
            {
                m.SendMessage("Please choose  your 5 skills to set to 100.");
                m.CloseGump(typeof(SkilllimPickGump1000));
                m.SendGump(new SkilllimPickGump1000(this));
            }
            else
        ...
        public SkillBall1000(Serial serial)
            : base(serial)
        {
        }
