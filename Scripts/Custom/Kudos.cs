...
namespace Felladrin.Items
{
    public class Kudos : Item
    {
        public static class Config
        {
            ...
            public static int MinutesOnline = 10;                            // Every X minutes we give kudos to all players online.
            ...
            protected override void OnTick()
            {
                foreach (NetState state in NetState.Instances)
                {
                    ...
                    if (m != null && m.AccessLevel <= Config.MaxAccessLevel)
                    {
                        ...
                        {
							m.SendMessage("1x kudos have been added to your bank as a thanks for playing here.");
