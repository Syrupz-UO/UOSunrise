...
namespace Server.Items
{
	class SwiftBoots : BaseArmor
	{
		...
		private static readonly TimeSpan UsageInterval = new TimeSpan(0, 0, 1, 0);
		// Effect lasts for 1 minute by default
		private static readonly TimeSpan EffectDuration = new TimeSpan(1, 0, 0, 0);
		// Hue of the boots
		...
		public override bool OnEquip( Mobile from )
		{
			...
			{
				from.SendMessage(38, "You need to wait for one minute until the magic recharges.");
			}
