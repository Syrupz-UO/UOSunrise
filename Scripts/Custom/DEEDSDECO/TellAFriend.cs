 ...
 *
 * Please note only the referrer receives a reward, but you can easily give a reward to the new player as well.
...
namespace Server
{
    public class TellAFriend
    {
        ...
        public static readonly TimeSpan RewardTime = TimeSpan.FromSeconds(20.0);
        ...
        // Edit Shard Name
        public static readonly string TAFShardName = "UOSunrise";
