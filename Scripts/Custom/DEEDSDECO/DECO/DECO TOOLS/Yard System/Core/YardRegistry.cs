...
namespace Server.ACC.YS
{
  ...
  //      public static Dictionary<int, int[]> YardStairIDGroups;
    ...
    /*        //Stairs"
            ...
            RegisterEntry("Floors", 1993, "Wood Planks 1", 50);
            RegisterEntry("Floors", 1997, "Wood Planks 2", 50);
            RegisterEntry("Floors", 1173, "Floor 1", 50);
            RegisterEntry("Floors", 1193, "Floor 2", 50);
            RegisterEntry("Floors", 1250, "Floor 3", 50);
            RegisterEntry("Floors", 1289, "Floor 4", 50);
            RegisterEntry("Floors", 1294, "Floor 5", 50);
            RegisterEntry("Floors", 1301, "Floor 6", 50);
            RegisterEntry("Floors", 1035, "Dirt 1", 50);
            RegisterEntry("Floors", 1039, "Dirt 2", 50);
            RegisterEntry("Floors", 1043, "Dirt 3", 50);
            RegisterEntry("Floors", 1047, "Dirt 4", 50);
            RegisterEntry("Floors", 1051, "Dirt 5", 50);
            RegisterEntry("Floors", 12789, "Dirt 6", 50);
