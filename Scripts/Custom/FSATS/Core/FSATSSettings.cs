...
namespace Server
{
	...
	public class FSATS
	{
		...
		***********************************************/
		...
		public static readonly int BioDEX = 550;

		//Bio Creatures INT Cap
		public static readonly int BioINT = 1000;

		//Bio Creatures HITS Cap
		public static readonly int BioHITS = 2500;

		//Bio Creatures STAM Cap
		public static readonly int BioSTAM = 1000;

		//Bio Creatures MANA Cap
		public static readonly int BioMANA = 1000;

		//Bio Creatures Min Damage Cap
		public static readonly int BioMinDam = 10;

		//Bio Creatures Max Damage Cap
		public static readonly int BioMaxDam = 18;

		//Bio Creatures PhysResist Cap
		public static readonly int BioPhys = 70;

		//Bio Creatures PhysFire Cap
		public static readonly int BioFire = 70;

		//Bio Creatures PhysCold Cap
		public static readonly int BioCold = 70;

		//Bio Creatures PhysEnergy Cap
		public static readonly int BioEnergy = 70;

		//Bio Creatures PhysPoison Cap
		public static readonly int BioPoison = 70;
