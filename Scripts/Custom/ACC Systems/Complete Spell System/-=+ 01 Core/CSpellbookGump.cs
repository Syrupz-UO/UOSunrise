...
namespace Server.ACC.CSS
{
    public abstract class CSpellbookGump : Gump
    {
            ...
            : base(50, 100)
        {
            ...
            Pages = (int)Math.Ceiling((book.SpellCount / 7.5)); //////////////////////////RIGHTHEREBEEEEEEEAAAATTTTCCCCHHHH/////////////////////////////4
          //  Console.WriteLine("SpellCount{0}", book.SpellCount);
          //  Console.WriteLine("Pages:{0}",Pages.ToString());
