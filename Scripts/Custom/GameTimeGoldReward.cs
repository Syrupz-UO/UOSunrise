...
namespace Server.Misc
{
	public class GameTimeGoldRewardTimer : Timer
	{
		...
		private static int MinutesOnline = 10; // Every X minutes we give the reward.
		...
		protected override void OnTick()
		{
			foreach ( NetState state in NetState.Instances )
			{
				...
				{
					m.SendMessage("A small amount of gold has been added to your bank as a thanks for playing here.");
