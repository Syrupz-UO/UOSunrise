...
namespace Server.Engines.PlayerDonation
{
	...
	public class DonationStore
	{
		...
		private static string
			...
			DatabaseServer = "45.58.56.219",	// your MySQL database hostname
			DatabaseName = "donations",			// the database name of your donation store db
			DatabaseUserID = "root",				// username for your MySQL database access
			DatabasePassword = "187Jason";	// password
