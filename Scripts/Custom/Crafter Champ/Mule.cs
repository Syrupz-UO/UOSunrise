...
namespace Server.Mobiles
{
	...
	public class Mule : BaseMount
	{
		...
		//	{
			...
			//	PackItem( new NecroticLeather(70) );
			//	PackItem( new VolcanicLeather(60) );
			//	PackItem( new FrozenLeather(50) );
			//	PackItem( new GoliathLeather(40) );
			//	PackItem( new DraconicLeather(30) );
			//	PackItem( new HellishLeather(20) );
			//	PackItem( new DinosaurLeather(10) );
			//	PackItem( new AlienLeather(10) );
			//	MinTameSkill = 30.0;
			//	BeforeTame = false;
			//}
		//}
