	...
	public class MasterOfTheArts : BaseCreature //make it use the creature files/settings
	{
			...
			if ( DateTime.UtcNow >= m_NextTalk && InRange( m, 4 ) && InLOS( m ) ) // check if it's time to talk & mobile in range & in los.
			{
				...
				switch ( Utility.Random( 3 ))
				{
					case 0: Say("YOU NO TAKE CANDLE!"); //make it say ...
						...
						break;
					case 1: Say("HULK SMASH"); 
						PlaySound(1071); //play huh sound
						break;	
					case 2: Say("ME SMASH HUMAN."); 
		...
		public void GiveCraftPowerScroll() //Generate power scroll routine and add to pack
		{
			...
			for ( int i = 0; i < PsCount; ++i ) 
			{
				...
				{
					switch ( Utility.Random( 55 )) //select random number between 0-46
					{
						case 0: m.AddToBackpack( new RunicFletcherTools( CraftResource.AshTree, 10 ) ); break; // pine runic fletcher tool with 10 charges
						case 1: m.AddToBackpack( new RunicFletcherTools( CraftResource.CherryTree, 10 ) ); break;
						case 2: m.AddToBackpack( new RunicFletcherTools( CraftResource.EbonyTree, 10 ) ); break;
                        case 3: m.AddToBackpack(new RunicFletcherTools(CraftResource.GoldenOakTree, 10)); break;
                        case 4: m.AddToBackpack(new RunicFletcherTools(CraftResource.HickoryTree, 10)); break;
						case 5: m.AddToBackpack( new RunicFletcherTools( CraftResource.MahoganyTree, 10 ) ); break;
						case 6: m.AddToBackpack( new RunicFletcherTools( CraftResource.OakTree, 10 ) ); break;
						case 7: m.AddToBackpack( new RunicFletcherTools( CraftResource.PineTree, 10 ) ); break;
						case 8: m.AddToBackpack( new RunicFletcherTools( CraftResource.GhostTree, 10 ) ); break;
						case 9: m.AddToBackpack( new RunicFletcherTools( CraftResource.RosewoodTree, 10 ) ); break;
						case 10: m.AddToBackpack( new RunicFletcherTools( CraftResource.WalnutTree, 10 ) ); break;
						case 11: m.AddToBackpack( new RunicFletcherTools( CraftResource.PetrifiedTree, 10 ) ); break;
						case 12: m.AddToBackpack( new RunicFletcherTools( CraftResource.DriftwoodTree, 10 ) ); break;
						case 13: m.AddToBackpack( new RunicFletcherTools( CraftResource.ElvenTree, 10 ) ); break;
						case 14: m.AddToBackpack( new RunicHammer( CraftResource.DullCopper, 10 ) ); break; // Dull Copper runic hamemr with 10 charges
						case 15: m.AddToBackpack( new RunicHammer( CraftResource.ShadowIron, 10 ) ); break;
						case 16: m.AddToBackpack( new RunicHammer( CraftResource.Copper, 10 ) ); break;
						case 17: m.AddToBackpack( new RunicHammer( CraftResource.Bronze, 10 ) ); break;
						case 18: m.AddToBackpack( new RunicHammer( CraftResource.Gold, 10 ) ); break;
						case 19: m.AddToBackpack( new RunicHammer( CraftResource.Agapite, 10 ) ); break;
						case 20: m.AddToBackpack( new RunicHammer( CraftResource.Verite, 10 ) ); break;
						case 21: m.AddToBackpack( new RunicHammer( CraftResource.Valorite, 10 ) ); break;
						case 22: m.AddToBackpack( new RunicHammer( CraftResource.Nepturite, 10 ) ); break;
						case 23: m.AddToBackpack( new RunicHammer( CraftResource.Obsidian, 10 ) ); break;
						case 24: m.AddToBackpack( new RunicHammer( CraftResource.Steel, 10 ) ); break;
						case 25: m.AddToBackpack( new RunicHammer( CraftResource.Brass, 10 ) ); break;
						case 26: m.AddToBackpack( new RunicHammer( CraftResource.Mithril, 10 ) ); break;
						case 27: m.AddToBackpack( new RunicHammer( CraftResource.Xormite, 10 ) ); break;
						case 28: m.AddToBackpack( new RunicHammer( CraftResource.Dwarven, 10 ) ); break;
						case 29: m.AddToBackpack( new RunicSewingKit( CraftResource.SpinedLeather, 10 ) ); break; // Spined Leather runic sewing kit with 10 charges
						case 30: m.AddToBackpack( new RunicSewingKit( CraftResource.HornedLeather, 10 ) ); break;
						case 31: m.AddToBackpack( new RunicSewingKit( CraftResource.BarbedLeather, 10 ) ); break;
						case 32: m.AddToBackpack( new RunicSewingKit( CraftResource.NecroticLeather, 10 ) ); break;
						case 33: m.AddToBackpack( new RunicSewingKit( CraftResource.VolcanicLeather, 10 ) ); break;
						case 34: m.AddToBackpack( new RunicSewingKit( CraftResource.FrozenLeather, 10 ) ); break;
						case 35: m.AddToBackpack( new RunicSewingKit( CraftResource.GoliathLeather, 10 ) ); break;
						case 36: m.AddToBackpack( new RunicSewingKit( CraftResource.DraconicLeather, 10 ) ); break;
						case 37: m.AddToBackpack( new RunicSewingKit( CraftResource.HellishLeather, 10 ) ); break;
						case 38: m.AddToBackpack( new RunicSewingKit( CraftResource.DinosaurLeather, 10 ) ); break;
						case 39: m.AddToBackpack( new RunicSewingKit( CraftResource.AlienLeather, 10 ) ); break;
						case 40: m.AddToBackpack( new RunicTinkerTools( CraftResource.DullCopper, 10 ) ); break; // Dull Copper runic hamemr with 10 charges
						case 41: m.AddToBackpack( new RunicTinkerTools( CraftResource.ShadowIron, 10 ) ); break;
						case 42: m.AddToBackpack( new RunicTinkerTools( CraftResource.Copper, 10 ) ); break;
						case 43: m.AddToBackpack( new RunicTinkerTools( CraftResource.Bronze, 10 ) ); break;
						case 44: m.AddToBackpack( new RunicTinkerTools( CraftResource.Gold, 10 ) ); break;
						case 45: m.AddToBackpack( new RunicTinkerTools( CraftResource.Agapite, 10 ) ); break;
						case 46: m.AddToBackpack( new RunicTinkerTools( CraftResource.Verite, 10 ) ); break;
						case 47: m.AddToBackpack( new RunicTinkerTools( CraftResource.Valorite, 10 ) ); break;
						case 48: m.AddToBackpack( new RunicTinkerTools( CraftResource.Nepturite, 10 ) ); break;
						case 49: m.AddToBackpack( new RunicTinkerTools( CraftResource.Obsidian, 10 ) ); break;
						case 50: m.AddToBackpack( new RunicTinkerTools( CraftResource.Steel, 10 ) ); break;
						case 51: m.AddToBackpack( new RunicTinkerTools( CraftResource.Brass, 10 ) ); break;
						case 52: m.AddToBackpack( new RunicTinkerTools( CraftResource.Mithril, 10 ) ); break;
						case 53: m.AddToBackpack( new RunicTinkerTools( CraftResource.Xormite, 10 ) ); break;
						case 54: m.AddToBackpack( new RunicTinkerTools( CraftResource.Dwarven, 10 ) ); break;
