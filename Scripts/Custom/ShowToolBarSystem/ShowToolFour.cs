...
namespace Server.Gumps
{
    public class ShowToolFour : Gump
    {
        ...
        public ShowToolFour(PlayerMobile owner) : base(50, 10)
        {
            ...
            base.AddLabel(0xd7, 0x80, 0x40, "Welcome to UOSunrise!");
            base.AddLabel(150, 0xb9, 0x40, "This will return you to the main bank.");
            base.AddLabel(150, 0xd7, 0x40, "");
            base.AddLabel(150, 0xf5, 0x40, "");
            base.AddLabel(150, 0x113, 0x40, "");
            ...
            switch (info.ButtonID)
            {
                ...
                case 1:
                  /*  if (pm.Alive)
                    ...
                    pm.Map = Map.Trammel;
                    pm.Location = new Point3D(3437, 3425, 0);
                    return;
