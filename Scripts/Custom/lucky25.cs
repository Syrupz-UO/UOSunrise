...
{
	public class LuckTarget25 : Target
	{
		private LuckyHorseShoes25 m_Deed;

		public LuckTarget25( LuckyHorseShoes25 deed ) : base( 1, false, TargetFlags.None )
		{
			m_Deed = deed;
		}
	...
	public class LuckyHorseShoes25 : Item
	{
		[Constructable]
		public LuckyHorseShoes25() : base( 0xFB6 )
		{
			Weight = 1.0;
        ...
        public override void AddNameProperties(ObjectPropertyList list)
		{
			...
			list.Add( 1070722, "Adds 25 Luck To An Item" );
        }

		public LuckyHorseShoes25(Serial serial) : base(serial)
		{
		}
		...
		public override void OnDoubleClick( Mobile from )
		{
			...
			else
			{
				...
				from.Target = new LuckTarget25( this );
			}
		}
	}
}