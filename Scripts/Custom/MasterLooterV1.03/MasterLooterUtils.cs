...
namespace Daat99MasterLooterSystem
{
    public static class Daat99MasterLootersUtils
    {
		...
		{ 
			...
			typeof(BaseAddon),			typeof(BaseGranite),		typeof(BaseSocketAugmentation)
		};
		...
		{ 
			...
			typeof(Tourmaline), 	typeof(Board),		typeof(PowerScroll), typeof(ChippedAmethyst),
			typeof(FlawedAmethyst),	typeof(FlawlessAmethyst),	typeof(PerfectAmethyst),	typeof(PlainAmethyst),
			typeof(ChippedDiamond),	typeof(FlawedDiamond),	typeof(FlawlessDiamond),	typeof(PerfectDiamond),
			typeof(PlainDiamond),	typeof(ChippedRuby),	typeof(FlawedRuby),	typeof(FlawlessRuby),
			typeof(PerfectRuby),	typeof(PlainRuby),	typeof(ChippedEmerald),	typeof(FlawlessEmerald),
			typeof(PerfectEmerald),	typeof(PlainEmerald),	typeof(ChippedSapphire),	typeof(FlawlessSapphire),
			typeof(PerfectSapphire),	typeof(PlainSapphire),	typeof(ChippedSkull),	typeof(FlawlessSkull),
			typeof(PerfectSkull),	typeof(PlainSkull),	typeof(ChippedTopaz),	typeof(FlawlessTopaz),
			typeof(PerfectTopaz),	typeof(PlainTopaz), typeof(DDSilver),typeof(DDCopper),typeof(Gold)
		};
