...
namespace Server.Mobiles
{
	...
	public class BurningEmberSpider : BaseCreature
	{

		[Constructable]
		public BurningEmberSpider () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.15, 0.2 )
		{           
            Body = 173;
			BaseSoundID = 362;
            Hue = 1922;
		...
		public BurningEmberSpider( Serial serial ) : base( serial )
		{
		}
