...
{
	[CorpseName( "an Icy IcyMyrmidex corpse" )]
	public class IcyMyrmidex : BaseCreature
	{
		[Constructable]
		public IcyMyrmidex () : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public IcyMyrmidex( Serial serial ) : base( serial )
		{
		}
