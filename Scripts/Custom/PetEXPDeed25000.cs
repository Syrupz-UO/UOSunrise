...
{ 
   	public class PetEXPDeed25000 : Item 
   	{     
      	[Constructable] 
      	public PetEXPDeed25000() : base( 0x14F0 )
      	{ 
         	Movable = true;
			Hue = 1050;
		...
		public PetEXPDeed25000( Serial serial ) : base( serial ) 
		{ 
		}
		...
		{ 
			...
			else if( from.InRange( this.GetWorldLocation(), 2 ) ) 
			{
				...
				from.Target = new PetEXPTarget25000( this );
			} 
			else 
			{ 
        ...
        public override void GetProperties( ObjectPropertyList list )
        {
            ...
            list.Add( "<BASEFONT COLOR=#7FCAE7>Value:" + "<BASEFONT COLOR=#FFFFFF> 25.000" + "<BASEFONT COLOR=#7FCAE7> Effects:" + "<BASEFONT COLOR=#FFFFFF> Increases Pet Experience");	
        }
		...
		{ 
  		...
  		private class PetEXPTarget25000 : Target 
		{ 
			private Mobile m_Owner; 
			private Item m_Deed; 

			public PetEXPTarget25000( Item deed ) : base ( 10, false, TargetFlags.None ) 
			{ 
				m_Deed = deed; 
			} 
			...
			{ 
				...
				{ 
					...
					else if ( c.NextLevel <=25000 ) // HORUS
					{
