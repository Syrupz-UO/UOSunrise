...
{
	public class ArmorBlessTarget : Target // Create our targeting class (which we derive from the base target class)
	{
		private ArmorBlessDeed m_Deed;

		public ArmorBlessTarget( ArmorBlessDeed deed ) : base( 1, false, TargetFlags.None )
		{
			m_Deed = deed;
		}
	...
	public class ArmorBlessDeed : Item // Create the item class which is derived from the base item class
	{
		public override string DefaultName
		{
			get { return "an Armor bless deed"; }
		}

		[Constructable]
		public ArmorBlessDeed() : base( 0x14F0 )
		{
			Weight = 1.0;
			LootType = LootType.Blessed;
		}

		public ArmorBlessDeed( Serial serial ) : base( serial )
		{
		}
		...
		public override void OnDoubleClick( Mobile from ) // Override double click of the deed to call our target
		{
			...
			else
			{
				...
				from.Target = new ArmorBlessTarget( this ); // Call our target
			 }
		}	
	}
}