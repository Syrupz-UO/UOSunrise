...
namespace VitaNex.Mobiles
{
	...
	public abstract class AdvancedVendor : BaseVendor, IAdvancedVendor
	{
		...
		{
			var scalar = CashType.TypeEquals<Gold>() ? base.GetPriceScalar(buyer) : 100;
		...
		public void UpdateDynamicStock()
		{
			var priceScalar = GetPriceScalar(null);

			foreach (var info in _DynamicStock.Values)
			{
