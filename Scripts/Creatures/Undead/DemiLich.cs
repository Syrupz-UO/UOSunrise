	...
	public class DemiLich : BaseCreature
	{
		...
		public DemiLich() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			...
			switch( Utility.RandomMinMax( 0, 7 ) )
			{
				...
				case 6: bone = 0x430; Title = "the crypt thing";	Chance = 6;		Mgear = 4;	Thirst = bone;	Hunger = bone;	gear = "crypt";		Magic = 3;	break;
				case 7: bone = 0x497; Title = "the dark lich";		Chance = 4;		Mgear = 5;	Thirst = bone;	Hunger = bone;	gear = "dark";		Magic = 5;	break;
			}
