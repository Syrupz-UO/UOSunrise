...
namespace Server.Mobiles
{
	public class EtherealMount : Item, IMount, IMountItem, Engines.VeteranRewards.IRewardItem
	{
		...
		{
			if ( Server.Misc.DifficultyLevel.NoMountsInCertainRegions() && Server.Mobiles.AnimalTrainer.IsNoMountRegion( from.Region ) )
			{
			...
			else
			{
				...
				else if ( this is SkeletalMount ){ m_RegularID = 793; m_MountedID = 0x3EBB; }
				else if ( this is DeathKnightWarhorse ){ m_RegularID = 11676; m_MountedID = 0x3E92; }
				else if ( this is PaladinWarhorse ){ m_RegularID = 11676; m_MountedID = 0x3E92; }
				...
				else if ( this is EtherealRidgeback ){ m_RegularID = 0x2615; m_MountedID = 0x3EBA; }
				else if ( this is EtherealUnicorn ){ m_RegularID = 0x25CE; m_MountedID = 0x3EB4; }
				else if ( this is EtherealBeetle ){ m_RegularID = 0x260F; m_MountedID = 0x3EBC; }
				...
				else if ( this is ChargerOfTheFallen ){ m_RegularID = 0x2D9C; m_MountedID = 0x3E92; }
