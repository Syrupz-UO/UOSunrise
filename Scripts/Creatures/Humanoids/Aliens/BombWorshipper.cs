...
namespace Server.Mobiles 
{
	public class BombWorshipper : BaseCreature 
	{
		...
		public BombWorshipper() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 ) 
		{
			...
			{
				this.Body = 0x191; 
				this.Name = Name = NameList.RandomName( "dark_elf_prefix_male" ) + NameList.RandomName( "dark_elf_suffix_female" );
			} 
			else 
			{ 
				this.Body = 0x190; 
				this.Name = Name = NameList.RandomName( "dark_elf_prefix_female" ) + NameList.RandomName( "dark_elf_suffix_male" );
			}
