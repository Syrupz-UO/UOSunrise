...
{
	public class SailorMinstrel : BaseCreature
	{
		...
		[Constructable]
		public SailorMinstrel() : base( AIType.AI_Archer, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
		...
		public SailorMinstrel( Serial serial ) : base( serial )
		{
		}
