...
{
	public class EvilSailorMinstrel : BaseCreature
	{
		...
		[Constructable]
		public EvilSailorMinstrel() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public EvilSailorMinstrel( Serial serial ) : base( serial )
		{
		}
