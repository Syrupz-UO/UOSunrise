				...
				if ( iRuined != null )
				{
					...
					else if ( iRuined is BaseWeapon )
					{
						...
						if ( Server.Misc.MaterialInfo.IsAnyKindOfMetalItem( iRuined ) )
						{
							...
							{
								m.LocalOverheadMessage(MessageType.Emote, 0x22, true, "The dragon rusted one of your equipped items!");
		...
		public override void OnDeath( Container c )
		{
			...
			if ( rDrop != null && rDrop != "" )
			{
				...
				if ( killer != null && rBody != 61 )
				{
					...
					{
						if ( GetPlayerInfo.LuckyKiller( killer.Luck ) && Utility.RandomMinMax( 1, 25 ) == 1 && !this.Controlled )
						{
							DragonLamp lamp = new DragonLamp();
							lamp.Hue = this.Hue;
								lamp.Hue = MaterialInfo.GetMaterialColor( rDrop, "", 0 );
							lamp.LampName = "";
		...
		public void CreateDragon( string terrain )
		{
			if ( rHue < 1 )
			{
				...
				switch ( dragon )
				{
					...
					case 5: rHue = 0x82B; rScales = "yellow"; rName = "a glare dragon"; rDwell = "dungeon"; rFood = "gold"; rDrop = ""; rCategory = "radiation"; if ( rBody == 59 ){ rBreath = 11; } else { rBreath = 39; } rPoison = 0; rBlood = "glowing goo"; break;
					case 6: rHue = 0x8D8; rScales = "white"; rName = "a glaze dragon"; rDwell = "dungeon"; rFood = "gold"; rDrop = ""; rCategory = "radiation"; if ( rBody == 59 ){ rBreath = 11; } else { rBreath = 39; } rPoison = 0; rBlood = "glowing goo"; break;
					case 7: rHue = 0x921; rScales = "white"; rName = "a radiant dragon"; rDwell = "dungeon"; rFood = "moon"; rDrop = ""; rCategory = "radiation"; if ( rBody == 59 ){ rBreath = 11; } else { rBreath = 39; } rPoison = 0; rBlood = "toxic goo"; break;
					...
					case 22: rHue = 0x7C6; rScales = "yellow"; rName = "a bright dragon"; rDwell = "dungeon"; rFood = "fire"; rDrop = ""; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = ""; break;
					...
					case 31: rHue = 0x77E; rScales = "green"; rName = "a jadefire dragon"; rDwell = "dungeon"; rFood = "fire_meat"; rDrop = ""; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = ""; break;
					...
					case 34: rHue = 0x6F5; rScales = "purple"; rName = "a purple dragon"; rDwell = "dungeon"; rFood = "meat"; rDrop = ""; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = ""; break;
					...
					case 38: rHue = 0x7CA; rScales = "red"; rName = "a rubystar dragon"; rDwell = "dungeon"; rFood = "gems_moon"; rDrop = "star ruby"; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = ""; break;
					...
					case 54: rHue = 0x702; rScales = "red"; rName = "a redstar dragon"; rDwell = "dungeon"; rFood = "moon_fire"; rDrop = ""; rCategory = "radiation"; if ( rBody == 59 ){ rBreath = 11; } else { rBreath = 39; } rPoison = 0; rBlood = ""; break;
					...
					case 74: rHue = 0x776; rScales = "red"; rName = "a burnt dragon"; rDwell = "fire"; rFood = "fire"; rDrop = ""; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = "hot magma"; break;
					case 75: rHue = 0x86C; rScales = "red"; rName = "a fire dragon"; rDwell = "fire"; rFood = "fire"; rDrop = ""; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = "hot magma"; break;
					case 76: rHue = 0x701; rScales = "red"; rName = "a firelight dragon"; rDwell = "fire"; rFood = "fire"; rDrop = ""; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = "scorching ooze"; break;
					case 77: rHue = 0xB12; rScales = "red"; rName = "a lava dragon"; rDwell = "fire"; rFood = "fire"; rDrop = ""; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = "hot magma"; break;
					...
					case 79: rHue = 0xB13; rScales = "red"; rName = "a magma dragon"; rDwell = "fire"; rFood = "fire"; rDrop = ""; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = "hot magma"; break;
					case 80: rHue = 0x827; rScales = "red"; rName = "a vulcan dragon"; rDwell = "fire"; rFood = "fire"; rDrop = ""; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = "hot magma"; break;
					...
					case 82: rHue = 0xAFA; rScales = "red"; rName = "a cinder dragon"; rDwell = "fire"; rFood = "fire"; rDrop = ""; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = ""; break;
					case 83: rHue = 0x93D; rScales = "red"; rName = "a darkfire dragon"; rDwell = "fire"; rFood = "fire"; rDrop = ""; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = ""; break;
					case 84: rHue = 0xB54; rScales = "red"; rName = "a flare dragon"; rDwell = "fire"; rFood = "fire"; rDrop = ""; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = ""; break;
					case 85: rHue = 0x775; rScales = "red"; rName = "a hell dragon"; rDwell = "fire"; rFood = "fire"; rDrop = ""; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = ""; break;
					case 86: rHue = 0x779; rScales = "red"; rName = "a firerock dragon"; rDwell = "fire"; rFood = "fire_meat"; rDrop = ""; rCategory = "steam"; if ( rBody == 59 ){ rBreath = 16; } else { rBreath = 38; } rPoison = 0; rBlood = ""; break;
					...
					case 97: rHue = 0x706; rScales = "yellow"; rName = "a nova dragon"; rDwell = "land"; rFood = "moon"; rDrop = ""; rCategory = "radiation"; if ( rBody == 59 ){ rBreath = 11; } else { rBreath = 39; } rPoison = 0; rBlood = "glowing goo"; break;
					...
					case 104: rHue = 0x981; rScales = "red"; rName = "a solar dragon"; rDwell = "land"; rFood = "moon_fire"; rDrop = ""; rCategory = "radiation"; if ( rBody == 59 ){ rBreath = 11; } else { rBreath = 39; } rPoison = 0; rBlood = ""; break;
					case 105: rHue = 0x6F8; rScales = "white"; rName = "a star dragon"; rDwell = "land"; rFood = "moon"; rDrop = ""; rCategory = "star"; if ( rBody == 59 ){ rBreath = 45; } else { rBreath = 49; } rPoison = 0; rBlood = ""; break;
					case 106: rHue = 0x869; rScales = "yellow"; rName = "a sun dragon"; rDwell = "land"; rFood = "moon"; rDrop = ""; rCategory = "radiation"; if ( rBody == 59 ){ rBreath = 11; } else { rBreath = 39; } rPoison = 0; rBlood = ""; break;
					...
					case 132: rHue = 0xAF3; rScales = "white"; rName = "an ice dragon"; rDwell = "snow"; rFood = "gems"; rDrop = "ice"; rCategory = "cold"; if ( rBody == 59 ){ rBreath = 12; } else { rBreath = 19; } rPoison = 0; rBlood = "freezing water"; break;
					case 133: rHue = 0xB7A; rScales = "blue"; rName = "an icescale dragon"; rDwell = "snow"; rFood = "gems"; rDrop = "ice"; rCategory = "cold"; if ( rBody == 59 ){ rBreath = 12; } else { rBreath = 19; } rPoison = 0; rBlood = "freezing water"; break;
					case 134: rHue = 0xAFD; rScales = "white"; rName = "a silver dragon"; rDwell = "snow"; rFood = "meat"; rDrop = "silver"; rCategory = "fire"; if ( rBody == 59 ){ rBreath = 9; } else { rBreath = 17; } rPoison = 0; rBlood = "quick silver"; break;
					...
					case 144: rHue = 0x77D; rScales = "green"; rName = "a swampfire dragon"; rDwell = "swamp"; rFood = "meat_nox"; rDrop = ""; rCategory = "poison"; if ( rBody == 59 ){ rBreath = 10; } else { rBreath = 18; } rPoison = 0; rBlood = ""; break;
					...
					case 146: rHue = 0x7C7; rScales = "green"; rName = "a xormite dragon"; rDwell = "dungeon"; rFood = "moon"; rDrop = ""; rCategory = "radiation"; if ( rBody == 59 ){ rBreath = 11; } else { rBreath = 39; } rPoison = 0; rBlood = ""; break;
				}
