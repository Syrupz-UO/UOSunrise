...
namespace Server.Commands
{
	public class Monopoly
	{
		...
		public static void Monopoly_OnCommand( CommandEventArgs e )
		{
			...
			Generate( "Data/Decoration/Monopoly/Sosaria", Map.Trammel );
			Generate( "Data/Decoration/Monopoly/Lodor", Map.Felucca );
			Generate( "Data/Decoration/Monopoly/Serpent", Map.Malas );
			Generate( "Data/Decoration/Monopoly/IslesOfDread", Map.Tokuno );
			Generate( "Data/Decoration/Monopoly/Savage", Map.TerMur );
			Generate( "Data/Decoration/Monopoly/Underworld", Map.Ilshenar );
	...
	public class MonopoliesList
	{
		...
		public Item Construct()
		{
			...
			item.Weight = -3; // DJERYV TRACKER NUMBER FOR POSSIBLE DELETION OF DECORATIONS
